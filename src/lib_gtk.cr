...
lib LibGtk
  ...
  struct AboutDialog # object
    ...
    # Property license-type : LibGtk::License
    # Property logo : LibGdkPixbuf::Pixbuf
    # Property logo-icon-name : UInt8*
    # Property program-name : UInt8*
    # Property translator-credits : UInt8*
    # Property version : UInt8*
    # Property website : UInt8*
    # Property website-label : UInt8*
    # Property wrap-license : Bool
  ...
  struct AccelGroup # object
    ...
    # Property is-locked : Bool
    # Property modifier-mask : LibGdk::ModifierType
  ...
  fun accel_group_find = gtk_accel_group_find(this : AccelGroup*, find_func : -> Void, data : Void*) : LibGtk::AccelKey*
  ...
  struct AccelLabel # object
    ...
    # Property accel-closure : LibGObject::Closure
    # Property accel-widget : LibGtk::Widget
  end
  ...
  fun accel_map_foreach = gtk_accel_map_foreach(data : Void*, foreach_func : -> Void) : Void
  fun accel_map_foreach_unfiltered = gtk_accel_map_foreach_unfiltered(data : Void*, foreach_func : -> Void) : Void
  ...
  struct Action # object
    ...
    # Property action-group : LibGtk::ActionGroup
    # Property always-show-image : Bool
    # Property gicon : LibGio::Icon
    # Property hide-if-empty : Bool
    # Property icon-name : UInt8*
    # Property is-important : Bool
    # Property label : UInt8*
    # Property name : UInt8*
    # Property sensitive : Bool
    # Property short-label : UInt8*
    # Property stock-id : UInt8*
    # Property tooltip : UInt8*
    # Property visible : Bool
    # Property visible-horizontal : Bool
    # Property visible-overflown : Bool
    # Property visible-vertical : Bool
    # Signal activate
  ...
  struct ActionGroup # object
    ...
    # Property accel-group : LibGtk::AccelGroup
    # Property name : UInt8*
    # Property sensitive : Bool
    # Property visible : Bool
  ...
  fun action_group_set_translate_func = gtk_action_group_set_translate_func(this : ActionGroup*, func : -> Void, data : Void*, notify : -> Void) : Void
  ...
  struct Adjustment # object
    ...
    # Property page-increment : Float64
    # Property page-size : Float64
    # Property step-increment : Float64
  ...
  struct Alignment # object
    ...
    # Property bottom-padding : UInt32
    # Property left-padding : UInt32
    # Property right-padding : UInt32
    # Property top-padding : UInt32
  ...
  struct AppChooserButton # object
    ...
    # Property show-default-item : Bool
    # Property show-dialog-item : Bool
  ...
  struct AppChooserWidget # object
    ...
    # Property default-text : UInt8*
    # Property show-all : Bool
    # Property show-default : Bool
    # Property show-fallback : Bool
    # Property show-other : Bool
    # Property show-recommended : Bool
  ...
  struct Application # object
    ...
    # Property active-window : LibGtk::Window
    # Property app-menu : LibGio::MenuModel
    # Property menubar : LibGio::MenuModel
    # Property register-session : Bool
    # Signal window-added
  ...
  struct Arrow # object
    ...
    # Property arrow-type : LibGtk::ArrowType
    # Property shadow-type : LibGtk::ShadowType
  end
  ...
  fun assistant_set_forward_page_func = gtk_assistant_set_forward_page_func(this : Assistant*, page_func : -> Void, data : Void*, destroy : -> Void) : Void
  ...
  struct Box # object
    ...
    # Property baseline-position : LibGtk::BaselinePosition
  ...
  struct Builder # object
    ...
    # Property translation-domain : UInt8*
  ...
  fun builder_add_callback_symbol = gtk_builder_add_callback_symbol(this : Builder*, callback_name : UInt8*, callback_symbol : -> Void) : Void
  ...
  fun builder_connect_signals_full = gtk_builder_connect_signals_full(this : Builder*, func : -> Void, user_data : Void*) : Void
  ...
  struct Button # object
    ...
    # Property always-show-image : Bool
    # Property focus-on-click : Bool
    # Property image : LibGtk::Widget
    # Property image-position : LibGtk::PositionType
    # Property label : UInt8*
    # Property relief : LibGtk::ReliefStyle
    # Property use-stock : Bool
    # Property use-underline : Bool
    # Property xalign : Float32
    # Property yalign : Float32
    # Signal activate
    # Signal clicked
  ...
  struct ButtonBox # object
    ...
    # Property layout-style : LibGtk::ButtonBoxStyle
  end
  ...
  struct Calendar # object
    ...
    # Property day : Int32
    # Property detail-height-rows : Int32
    # Property detail-width-chars : Int32
    # Property month : Int32
    # Property no-month-change : Bool
    # Property show-day-names : Bool
    # Property show-details : Bool
    # Property show-heading : Bool
    # Property show-week-numbers : Bool
    # Property year : Int32
    # Signal day-selected
  ...
  fun calendar_set_detail_func = gtk_calendar_set_detail_func(this : Calendar*, func : -> Void, data : Void*, destroy : -> Void) : Void
  ...
  struct CellArea # object
    ...
    # Property edit-widget : LibGtk::CellEditable
    # Property edited-cell : LibGtk::CellRenderer
    # Property focus-cell : LibGtk::CellRenderer
    # Signal add-editable
  ...
  fun cell_area_foreach = gtk_cell_area_foreach(this : CellArea*, callback : -> Void, callback_data : Void*) : Void
  fun cell_area_foreach_alloc = gtk_cell_area_foreach_alloc(this : CellArea*, context : LibGtk::CellAreaContext*, widget : LibGtk::Widget*, cell_area : Libcairo::RectangleInt*, background_area : Libcairo::RectangleInt*, callback : -> Void, callback_data : Void*) : Void
  ...
  struct CellAreaContext # object
    ...
    # Property minimum-height : Int32
    # Property minimum-width : Int32
    # Property natural-height : Int32
    # Property natural-width : Int32
  ...
  struct CellRenderer # object
    ...
    # Property cell-background : UInt8*
    # Property cell-background-gdk : LibGdk::Color
    # Property cell-background-rgba : LibGdk::RGBA
    # Property cell-background-set : Bool
    # Property editing : Bool
    # Property height : Int32
    # Property is-expanded : Bool
    # Property is-expander : Bool
  ...
  struct CellRendererAccel # object
    ...
    # Property accel-key : UInt32
    # Property accel-mode : LibGtk::CellRendererAccelMode
    # Property accel-mods : LibGdk::ModifierType
  ...
  struct CellRendererCombo # object
    ...
    # Property has-entry : Bool
    # Property model : LibGtk::TreeModel
    # Property text-column : Int32
    # Signal changed
  end
  ...
  struct CellRendererPixbuf # object
    ...
    # Property follow-state : Bool
    # Property gicon : LibGio::Icon
    # Property icon-name : UInt8*
    # Property pixbuf : LibGdkPixbuf::Pixbuf
    # Property pixbuf-expander-closed : LibGdkPixbuf::Pixbuf
    # Property pixbuf-expander-open : LibGdkPixbuf::Pixbuf
    # Property stock-detail : UInt8*
    # Property stock-id : UInt8*
    # Property stock-size : UInt32
  ...
  struct CellRendererProgress # object
    ...
    # Property text : UInt8*
    # Property text-xalign : Float32
    # Property text-yalign : Float32
  ...
  struct CellRendererText # object
    ...
    # Property align-set : Bool
    # Property alignment : LibPango::Alignment
    # Property attributes : LibPango::AttrList
    # Property background : UInt8*
    # Property background-gdk : LibGdk::Color
    # Property background-rgba : LibGdk::RGBA
    # Property background-set : Bool
    # Property editable : Bool
    # Property editable-set : Bool
    # Property ellipsize : LibPango::EllipsizeMode
    # Property ellipsize-set : Bool
    # Property family : UInt8*
    # Property family-set : Bool
    # Property font : UInt8*
    # Property font-desc : LibPango::FontDescription
    # Property foreground : UInt8*
    # Property foreground-gdk : LibGdk::Color
    # Property foreground-rgba : LibGdk::RGBA
    # Property foreground-set : Bool
    # Property language : UInt8*
    # Property language-set : Bool
    # Property markup : UInt8*
    # Property max-width-chars : Int32
    # Property placeholder-text : UInt8*
    # Property rise : Int32
    # Property rise-set : Bool
    # Property scale : Float64
    # Property scale-set : Bool
    # Property single-paragraph-mode : Bool
    # Property size : Int32
    # Property size-points : Float64
    # Property size-set : Bool
    # Property stretch : LibPango::Stretch
    # Property stretch-set : Bool
    # Property strikethrough : Bool
    # Property strikethrough-set : Bool
    # Property style : LibPango::Style
    # Property style-set : Bool
    # Property text : UInt8*
    # Property underline : LibPango::Underline
    # Property underline-set : Bool
    # Property variant : LibPango::Variant
    # Property variant-set : Bool
    # Property weight : Int32
    # Property weight-set : Bool
    # Property width-chars : Int32
    # Property wrap-mode : LibPango::WrapMode
    # Property wrap-width : Int32
    # Signal edited
  ...
  struct CellView # object
    ...
    # Property background-rgba : LibGdk::RGBA
    # Property background-set : Bool
    # Property cell-area : LibGtk::CellArea
    # Property cell-area-context : LibGtk::CellAreaContext
    # Property draw-sensitive : Bool
    # Property fit-model : Bool
    # Property model : LibGtk::TreeModel
  end
  ...
  fun clipboard_request_contents = gtk_clipboard_request_contents(this : Clipboard*, target : LibGdk::Atom*, callback : -> Void, user_data : Void*) : Void
  fun clipboard_request_image = gtk_clipboard_request_image(this : Clipboard*, callback : -> Void, user_data : Void*) : Void
  fun clipboard_request_rich_text = gtk_clipboard_request_rich_text(this : Clipboard*, buffer : LibGtk::TextBuffer*, callback : -> Void, user_data : Void*) : Void
  fun clipboard_request_targets = gtk_clipboard_request_targets(this : Clipboard*, callback : -> Void, user_data : Void*) : Void
  fun clipboard_request_text = gtk_clipboard_request_text(this : Clipboard*, callback : -> Void, user_data : Void*) : Void
  fun clipboard_request_uris = gtk_clipboard_request_uris(this : Clipboard*, callback : -> Void, user_data : Void*) : Void
  ...
  struct ColorSelection # object
    ...
    # Property current-alpha : UInt32
    # Property current-color : LibGdk::Color
    # Property current-rgba : LibGdk::RGBA
    # Property has-opacity-control : Bool
    # Property has-palette : Bool
  ...
  struct ColorSelectionDialog # object
    ...
    # Property cancel-button : LibGtk::Widget
    # Property color-selection : LibGtk::Widget
    # Property help-button : LibGtk::Widget
    # Property ok-button : LibGtk::Widget
  end
  ...
  struct ComboBox # object
    ...
    # Property active-id : UInt8*
    # Property add-tearoffs : Bool
    # Property button-sensitivity : LibGtk::SensitivityType
    # Property cell-area : LibGtk::CellArea
    # Property column-span-column : Int32
    # Property entry-text-column : Int32
    # Property focus-on-click : Bool
    # Property has-entry : Bool
    # Property has-frame : Bool
    # Property id-column : Int32
    # Property model : LibGtk::TreeModel
    # Property popup-fixed-width : Bool
    # Property popup-shown : Bool
    # Property row-span-column : Int32
    # Property tearoff-title : UInt8*
    # Property wrap-width : Int32
    # Signal changed
  ...
  fun combo_box_set_active = gtk_combo_box_set_active(this : ComboBox*, index_ : Int32) : Void
  ...
  fun combo_box_set_row_separator_func = gtk_combo_box_set_row_separator_func(this : ComboBox*, func : -> Void, data : Void*, destroy : -> Void) : Void
  ...
  struct Container # object
    ...
    # Property border-width : UInt32
    # Property child : LibGtk::Widget
    # Property resize-mode : LibGtk::ResizeMode
    # Signal add
    # Signal check-resize
    # Signal remove
  ...
  fun container_forall = gtk_container_forall(this : Container*, callback : -> Void, callback_data : Void*) : Void
  fun container_foreach = gtk_container_foreach(this : Container*, callback : -> Void, callback_data : Void*) : Void
  ...
  struct Entry # object
    ...
    # Property activates-default : Bool
    # Property attributes : LibPango::AttrList
    # Property buffer : LibGtk::EntryBuffer
    # Property caps-lock-warning : Bool
    # Property completion : LibGtk::EntryCompletion
    # Property cursor-position : Int32
    # Property editable : Bool
    # Property has-frame : Bool
    # Property im-module : UInt8*
    # Property inner-border : LibGtk::Border
    # Property input-hints : LibGtk::InputHints
    # Property input-purpose : LibGtk::InputPurpose
    # Property invisible-char : UInt32
    # Property invisible-char-set : Bool
    # Property max-length : Int32
    # Property max-width-chars : Int32
    # Property overwrite-mode : Bool
    # Property placeholder-text : UInt8*
    # Property populate-all : Bool
    # Property primary-icon-activatable : Bool
    # Property primary-icon-gicon : LibGio::Icon
    # Property primary-icon-name : UInt8*
    # Property primary-icon-pixbuf : LibGdkPixbuf::Pixbuf
    # Property primary-icon-sensitive : Bool
    # Property primary-icon-stock : UInt8*
    # Property primary-icon-storage-type : LibGtk::ImageType
    # Property primary-icon-tooltip-markup : UInt8*
    # Property primary-icon-tooltip-text : UInt8*
    # Property progress-fraction : Float64
    # Property progress-pulse-step : Float64
    # Property scroll-offset : Int32
    # Property secondary-icon-activatable : Bool
    # Property secondary-icon-gicon : LibGio::Icon
    # Property secondary-icon-name : UInt8*
    # Property secondary-icon-pixbuf : LibGdkPixbuf::Pixbuf
    # Property secondary-icon-sensitive : Bool
    # Property secondary-icon-stock : UInt8*
    # Property secondary-icon-storage-type : LibGtk::ImageType
    # Property secondary-icon-tooltip-markup : UInt8*
    # Property secondary-icon-tooltip-text : UInt8*
    # Property selection-bound : Int32
    # Property shadow-type : LibGtk::ShadowType
    # Property tabs : LibPango::TabArray
    # Property text : UInt8*
    # Property text-length : UInt32
    # Property truncate-multiline : Bool
  ...
  struct EntryCompletion # object
    ...
    # Property cell-area : LibGtk::CellArea
    # Property inline-completion : Bool
    # Property inline-selection : Bool
    # Property minimum-key-length : Int32
    # Property model : LibGtk::TreeModel
    # Property popup-completion : Bool
    # Property popup-set-width : Bool
    # Property popup-single-match : Bool
    # Property text-column : Int32
  ...
  fun entry_completion_delete_action = gtk_entry_completion_delete_action(this : EntryCompletion*, index_ : Int32) : Void
  ...
  fun entry_completion_insert_action_markup = gtk_entry_completion_insert_action_markup(this : EntryCompletion*, index_ : Int32, markup : UInt8*) : Void
  fun entry_completion_insert_action_text = gtk_entry_completion_insert_action_text(this : EntryCompletion*, index_ : Int32, text : UInt8*) : Void
  ...
  fun entry_completion_set_match_func = gtk_entry_completion_set_match_func(this : EntryCompletion*, func : -> Void, func_data : Void*, func_notify : -> Void) : Void
  ...
  struct EventBox # object
    ...
    # Property above-child : Bool
    # Property visible-window : Bool
  end
  ...
  struct EventController # object
    # Property propagation-phase : LibGtk::PropagationPhase
    # Property widget : LibGtk::Widget
  end
  ...
  struct Expander # object
    ...
    # Property label : UInt8*
    # Property label-fill : Bool
    # Property label-widget : LibGtk::Widget
    # Property resize-toplevel : Bool
    # Property spacing : Int32
    # Property use-markup : Bool
    # Property use-underline : Bool
    # Signal activate
    # Virtual function activate
  end
  ...
  fun file_filter_add_custom = gtk_file_filter_add_custom(this : FileFilter*, needed : LibGtk::FileFilterFlags, func : -> Void, data : Void*, notify : -> Void) : Void
  ...
  struct FlowBox # object
    ...
    # Implements Orientable
    container : LibGtk::Container
    # Property activate-on-single-click : Bool
    # Property column-spacing : UInt32
    # Property homogeneous : Bool
    # Property max-children-per-line : UInt32
    # Property min-children-per-line : UInt32
    # Property row-spacing : UInt32
    # Property selection-mode : LibGtk::SelectionMode
  ...
  fun flow_box_selected_foreach = gtk_flow_box_selected_foreach(this : FlowBox*, func : -> Void, data : Void*) : Void
  ...
  fun flow_box_set_filter_func = gtk_flow_box_set_filter_func(this : FlowBox*, filter_func : -> Void, user_data : Void*, destroy : -> Void) : Void
  ...
  fun flow_box_set_sort_func = gtk_flow_box_set_sort_func(this : FlowBox*, sort_func : -> Void, user_data : Void*, destroy : -> Void) : Void
  ...
  struct FontButton # object
    ...
    # Property font-name : UInt8*
    # Property show-size : Bool
    # Property show-style : Bool
    # Property title : UInt8*
    # Property use-font : Bool
    # Property use-size : Bool
    # Signal font-set
  ...
  struct Frame # object
    ...
    # Property label : UInt8*
    # Property label-widget : LibGtk::Widget
    # Property label-xalign : Float32
    # Property label-yalign : Float32
    # Property shadow-type : LibGtk::ShadowType
  ...
  struct Grid # object
    ...
    # Property baseline-row : Int32
    # Property column-homogeneous : Bool
    # Property column-spacing : Int32
    # Property row-homogeneous : Bool
    # Property row-spacing : Int32
  end
  ...
  struct HandleBox # object
    ...
    # Property child-detached : Bool
    # Property handle-position : LibGtk::PositionType
    # Property shadow-type : LibGtk::ShadowType
    # Property snap-edge : LibGtk::PositionType
    # Property snap-edge-set : Bool
  ...
  struct HeaderBar # object
    ...
    # Implements Buildable
    container : LibGtk::Container
    # Property custom-title : LibGtk::Widget
    # Property decoration-layout : UInt8*
    # Property decoration-layout-set : Bool
    # Property has-subtitle : Bool
    # Property show-close-button : Bool
    # Property spacing : Int32
  ...
  fun icon_info_load_icon_async = gtk_icon_info_load_icon_async(this : IconInfo*, cancellable : LibGio::Cancellable*, callback : -> Void, user_data : Void*) : Void
  ...
  fun icon_info_load_symbolic_async = gtk_icon_info_load_symbolic_async(this : IconInfo*, fg : LibGdk::RGBA*, success_color : LibGdk::RGBA*, warning_color : LibGdk::RGBA*, error_color : LibGdk::RGBA*, cancellable : LibGio::Cancellable*, callback : -> Void, user_data : Void*) : Void
  ...
  fun icon_info_load_symbolic_for_context_async = gtk_icon_info_load_symbolic_for_context_async(this : IconInfo*, context : LibGtk::StyleContext*, cancellable : LibGio::Cancellable*, callback : -> Void, user_data : Void*) : Void
  ...
  struct IconView # object
    ...
    # Property item-orientation : LibGtk::Orientation
    # Property item-padding : Int32
    # Property item-width : Int32
    # Property margin : Int32
    # Property markup-column : Int32
    # Property model : LibGtk::TreeModel
    # Property pixbuf-column : Int32
    # Property reorderable : Bool
    # Property row-spacing : Int32
    # Property selection-mode : LibGtk::SelectionMode
    # Property spacing : Int32
    # Property text-column : Int32
    # Property tooltip-column : Int32
  ...
  fun icon_view_selected_foreach = gtk_icon_view_selected_foreach(this : IconView*, func : -> Void, data : Void*) : Void
  ...
  struct Image # object
    ...
    # Property gicon : LibGio::Icon
    # Property icon-name : UInt8*
    # Property icon-set : LibGtk::IconSet
    # Property icon-size : Int32
    # Property pixbuf : LibGdkPixbuf::Pixbuf
    # Property pixbuf-animation : LibGdkPixbuf::PixbufAnimation
    # Property pixel-size : Int32
    # Property resource : UInt8*
    # Property stock : UInt8*
    # Property storage-type : LibGtk::ImageType
    # Property surface : Libcairo::Surface
  ...
  struct InfoBar # object
    ...
    # Property message-type : LibGtk::MessageType
    # Property show-close-button : Bool
    # Signal close
    # Signal response
    # Virtual function close
  ...
  struct Label # object
    ...
    # Property max-width-chars : Int32
    # Property mnemonic-keyval : UInt32
    # Property mnemonic-widget : LibGtk::Widget
    # Property pattern : UInt8*
    # Property selectable : Bool
    # Property selection-bound : Int32
    # Property single-line-mode : Bool
    # Property track-visited-links : Bool
    # Property use-markup : Bool
    # Property use-underline : Bool
    # Property width-chars : Int32
    # Property wrap : Bool
  ...
  struct LevelBar # object
    ...
    # Property inverted : Bool
    # Property max-value : Float64
    # Property min-value : Float64
  ...
  fun list_box_get_row_at_index = gtk_list_box_get_row_at_index(this : ListBox*, index_ : Int32) : LibGtk::ListBoxRow*
  ...
  fun list_box_selected_foreach = gtk_list_box_selected_foreach(this : ListBox*, func : -> Void, data : Void*) : Void
  ...
  fun list_box_set_filter_func = gtk_list_box_set_filter_func(this : ListBox*, filter_func : -> Void, user_data : Void*, destroy : -> Void) : Void
  fun list_box_set_header_func = gtk_list_box_set_header_func(this : ListBox*, update_header : -> Void, user_data : Void*, destroy : -> Void) : Void
  ...
  fun list_box_set_sort_func = gtk_list_box_set_sort_func(this : ListBox*, sort_func : -> Void, user_data : Void*, destroy : -> Void) : Void
  ...
  struct LockButton # object
    ...
    # Property text-lock : UInt8*
    # Property text-unlock : UInt8*
    # Property tooltip-lock : UInt8*
    # Property tooltip-not-authorized : UInt8*
    # Property tooltip-unlock : UInt8*
  end
  ...
  struct Menu # object
    ...
    # Property accel-group : LibGtk::AccelGroup
    # Property accel-path : UInt8*
    # Property active : Int32
    # Property attach-widget : LibGtk::Widget
    # Property monitor : Int32
    # Property reserve-toggle-size : Bool
    # Property tearoff-state : Bool
    # Property tearoff-title : UInt8*
    # Signal move-scroll
  end
  ...
  fun menu_attach_to_widget = gtk_menu_attach_to_widget(this : Menu*, attach_widget : LibGtk::Widget*, detacher : -> Void) : Void
  ...
  fun menu_popup = gtk_menu_popup(this : Menu*, parent_menu_shell : LibGtk::Widget*, parent_menu_item : LibGtk::Widget*, func : -> Void, data : Void*, button : UInt32, activate_time : UInt32) : Void
  fun menu_popup_for_device = gtk_menu_popup_for_device(this : Menu*, device : LibGdk::Device*, parent_menu_shell : LibGtk::Widget*, parent_menu_item : LibGtk::Widget*, func : -> Void, data : Void*, destroy : -> Void, button : UInt32, activate_time : UInt32) : Void
  ...
  struct MenuBar # object
    ...
    # Property child-pack-direction : LibGtk::PackDirection
    # Property pack-direction : LibGtk::PackDirection
  end
  ...
  struct MenuButton # object
    ...
    # Property align-widget : LibGtk::Container
    # Property direction : LibGtk::ArrowType
    # Property menu-model : LibGio::MenuModel
    # Property popover : LibGtk::Popover
    # Property popup : LibGtk::Menu
    # Property use-popover : Bool
  end
  ...
  struct MessageDialog # object
    ...
    # Property image : LibGtk::Widget
    # Property message-area : LibGtk::Widget
    # Property message-type : LibGtk::MessageType
    # Property secondary-text : UInt8*
    # Property secondary-use-markup : Bool
    # Property text : UInt8*
    # Property use-markup : Bool
  end
  ...
  struct Notebook # object
    ...
    # Property enable-popup : Bool
    # Property group-name : UInt8*
    # Property page : Int32
    # Property scrollable : Bool
    # Property show-border : Bool
    # Property show-tabs : Bool
    # Property tab-pos : LibGtk::PositionType
  ...
  struct NumerableIcon # object
    ...
    # Property background-icon : LibGio::Icon
    # Property background-icon-name : UInt8*
    # Property count : Int32
    # Property label : UInt8*
    # Property style-context : LibGtk::StyleContext
  end
  ...
  struct Paned # object
    ...
    # Property max-position : Int32
    # Property min-position : Int32
    # Property position : Int32
    # Property position-set : Bool
  ...
  struct PlacesSidebar # object
    ...
    # Property open-flags : LibGtk::PlacesOpenFlags
    # Property show-connect-to-server : Bool
    # Property show-desktop : Bool
    # Property show-enter-location : Bool
  ...
  struct Plug # object
    ...
    # Property socket-window : LibGdk::Window
    # Signal embedded
  ...
  struct Popover # object
    ...
    # Property modal : Bool
    # Property pointing-to : Libcairo::RectangleInt
    # Property position : LibGtk::PositionType
    # Property relative-to : LibGtk::Widget
    # Signal closed
  ...
  struct PrintOperation # object
    ...
    # Property allow-async : Bool
    # Property current-page : Int32
    # Property custom-tab-label : UInt8*
    # Property default-page-setup : LibGtk::PageSetup
    # Property embed-page-setup : Bool
    # Property export-filename : UInt8*
    # Property has-selection : Bool
    # Property job-name : UInt8*
    # Property n-pages : Int32
    # Property n-pages-to-print : Int32
    # Property print-settings : LibGtk::PrintSettings
    # Property show-progress : Bool
    # Property status : LibGtk::PrintStatus
    # Property status-string : UInt8*
    # Property support-selection : Bool
    # Property track-print-status : Bool
    # Property unit : LibGtk::Unit
    # Property use-full-page : Bool
    # Signal begin-print
  ...
  fun print_settings_foreach = gtk_print_settings_foreach(this : PrintSettings*, func : -> Void, user_data : Void*) : Void
  ...
  fun print_settings_get_double_with_default = gtk_print_settings_get_double_with_default(this : PrintSettings*, key : UInt8*, def : Float64) : Float64
  ...
  fun print_settings_get_int_with_default = gtk_print_settings_get_int_with_default(this : PrintSettings*, key : UInt8*, def : Int32) : Int32
  ...
  struct ProgressBar # object
    ...
    # Property inverted : Bool
    # Property pulse-step : Float64
    # Property show-text : Bool
    # Property text : UInt8*
  end
  ...
  struct Range # object
    ...
    # Property adjustment : LibGtk::Adjustment
    # Property fill-level : Float64
    # Property inverted : Bool
    # Property lower-stepper-sensitivity : LibGtk::SensitivityType
    # Property restrict-to-fill-level : Bool
    # Property round-digits : Int32
    # Property show-fill-level : Bool
    # Property upper-stepper-sensitivity : LibGtk::SensitivityType
  ...
  fun recent_filter_add_custom = gtk_recent_filter_add_custom(this : RecentFilter*, needed : LibGtk::RecentFilterFlags, func : -> Void, data : Void*, data_destroy : -> Void) : Void
  ...
  struct Revealer # object
    ...
    # Implements Buildable
    parent_instance : LibGtk::Bin
    # Property child-revealed : Bool
    # Property reveal-child : Bool
    # Property transition-duration : UInt32
    # Property transition-type : LibGtk::RevealerTransitionType
  end
  ...
  struct Scale # object
    ...
    # Property draw-value : Bool
    # Property has-origin : Bool
    # Property value-pos : LibGtk::PositionType
    # Signal format-value
  ...
  struct ScrolledWindow # object
    ...
    # Property hscrollbar-policy : LibGtk::PolicyType
    # Property kinetic-scrolling : Bool
    # Property min-content-height : Int32
    # Property min-content-width : Int32
    # Property shadow-type : LibGtk::ShadowType
    # Property vadjustment : LibGtk::Adjustment
    # Property vscrollbar-policy : LibGtk::PolicyType
    # Property window-placement : LibGtk::CornerType
    # Property window-placement-set : Bool
    # Signal move-focus-out
    # Signal scroll-child
    # Virtual function move_focus_out
  ...
  struct SearchBar # object
    ...
    # Implements Buildable
    parent : LibGtk::Bin
    # Property search-mode-enabled : Bool
    # Property show-close-button : Bool
  end
  ...
  struct Settings # object
    ...
    # Property color-hash : Void**
    # Property gtk-alternative-button-order : Bool
    # Property gtk-alternative-sort-arrows : Bool
    # Property gtk-application-prefer-dark-theme : Bool
    # Property gtk-auto-mnemonics : Bool
    # Property gtk-button-images : Bool
    # Property gtk-can-change-accels : Bool
    # Property gtk-color-palette : UInt8*
    # Property gtk-color-scheme : UInt8*
    # Property gtk-cursor-blink : Bool
    # Property gtk-cursor-blink-time : Int32
    # Property gtk-cursor-blink-timeout : Int32
    # Property gtk-cursor-theme-name : UInt8*
    # Property gtk-cursor-theme-size : Int32
    # Property gtk-decoration-layout : UInt8*
    # Property gtk-dialogs-use-header : Bool
    # Property gtk-dnd-drag-threshold : Int32
    # Property gtk-double-click-distance : Int32
    # Property gtk-double-click-time : Int32
    # Property gtk-enable-accels : Bool
    # Property gtk-enable-animations : Bool
    # Property gtk-enable-event-sounds : Bool
    # Property gtk-enable-input-feedback-sounds : Bool
    # Property gtk-enable-mnemonics : Bool
    # Property gtk-enable-primary-paste : Bool
    # Property gtk-enable-tooltips : Bool
    # Property gtk-entry-password-hint-timeout : UInt32
    # Property gtk-entry-select-on-focus : Bool
    # Property gtk-error-bell : Bool
    # Property gtk-fallback-icon-theme : UInt8*
    # Property gtk-file-chooser-backend : UInt8*
    # Property gtk-font-name : UInt8*
    # Property gtk-fontconfig-timestamp : UInt32
    # Property gtk-icon-sizes : UInt8*
    # Property gtk-icon-theme-name : UInt8*
    # Property gtk-im-module : UInt8*
    # Property gtk-im-preedit-style : LibGtk::IMPreeditStyle
    # Property gtk-im-status-style : LibGtk::IMStatusStyle
    # Property gtk-key-theme-name : UInt8*
    # Property gtk-keynav-cursor-only : Bool
    # Property gtk-keynav-wrap-around : Bool
    # Property gtk-label-select-on-focus : Bool
    # Property gtk-long-press-time : UInt32
    # Property gtk-menu-bar-accel : UInt8*
    # Property gtk-menu-bar-popup-delay : Int32
    # Property gtk-menu-images : Bool
    # Property gtk-menu-popdown-delay : Int32
    # Property gtk-menu-popup-delay : Int32
    # Property gtk-modules : UInt8*
    # Property gtk-primary-button-warps-slider : Bool
    # Property gtk-print-backends : UInt8*
    # Property gtk-print-preview-command : UInt8*
    # Property gtk-recent-files-enabled : Bool
    # Property gtk-recent-files-limit : Int32
    # Property gtk-recent-files-max-age : Int32
    # Property gtk-scrolled-window-placement : LibGtk::CornerType
    # Property gtk-shell-shows-app-menu : Bool
    # Property gtk-shell-shows-desktop : Bool
    # Property gtk-shell-shows-menubar : Bool
    # Property gtk-show-input-method-menu : Bool
    # Property gtk-show-unicode-menu : Bool
    # Property gtk-sound-theme-name : UInt8*
    # Property gtk-split-cursor : Bool
    # Property gtk-theme-name : UInt8*
    # Property gtk-timeout-expand : Int32
    # Property gtk-timeout-initial : Int32
    # Property gtk-timeout-repeat : Int32
    # Property gtk-titlebar-double-click : UInt8*
    # Property gtk-titlebar-middle-click : UInt8*
    # Property gtk-titlebar-right-click : UInt8*
    # Property gtk-toolbar-icon-size : LibGtk::IconSize
    # Property gtk-toolbar-style : LibGtk::ToolbarStyle
    # Property gtk-tooltip-browse-mode-timeout : Int32
    # Property gtk-tooltip-browse-timeout : Int32
    # Property gtk-tooltip-timeout : Int32
    # Property gtk-touchscreen-mode : Bool
    # Property gtk-visible-focus : LibGtk::PolicyType
    # Property gtk-xft-antialias : Int32
    # Property gtk-xft-dpi : Int32
    # Property gtk-xft-hinting : Int32
    # Property gtk-xft-hintstyle : UInt8*
    # Property gtk-xft-rgba : UInt8*
  end
  ...
  fun settings_install_property_parser = gtk_settings_install_property_parser(pspec : LibGObject::ParamSpec*, parser : -> Void) : Void
  ...
  struct SpinButton # object
    ...
    # Property snap-to-ticks : Bool
    # Property update-policy : LibGtk::SpinButtonUpdatePolicy
    # Property value : Float64
    # Property wrap : Bool
    # Signal change-value
    # Signal input
  ...
  struct Stack # object
    ...
    # Property homogeneous : Bool
    # Property transition-duration : UInt32
    # Property transition-running : Bool
    # Property transition-type : LibGtk::StackTransitionType
    # Property visible-child : LibGtk::Widget
    # Property visible-child-name : UInt8*
  end
  ...
  struct StatusIcon # object
    ...
    # Property storage-type : LibGtk::ImageType
    # Property title : UInt8*
    # Property tooltip-markup : UInt8*
    # Property tooltip-text : UInt8*
    # Property visible : Bool
    # Signal activate
  ...
  struct StyleContext # object
    ...
    # Property paint-clock : LibGdk::FrameClock
  ...
  struct Table # object
    ...
    # Property column-spacing : UInt32
    # Property homogeneous : Bool
    # Property n-columns : UInt32
    # Property n-rows : UInt32
    # Property row-spacing : UInt32
  end
  ...
  struct TextBuffer # object
    ...
    # Property copy-target-list : LibGtk::TargetList
    # Property cursor-position : Int32
    # Property has-selection : Bool
    # Property paste-target-list : LibGtk::TargetList
    # Property tag-table : LibGtk::TextTagTable
    # Property text : UInt8*
    # Signal apply-tag
  ...
  fun text_buffer_register_deserialize_format = gtk_text_buffer_register_deserialize_format(this : TextBuffer*, mime_type : UInt8*, function : -> Void, user_data : Void*, user_data_destroy : -> Void) : LibGdk::Atom*
  ...
  fun text_buffer_register_serialize_format = gtk_text_buffer_register_serialize_format(this : TextBuffer*, mime_type : UInt8*, function : -> Void, user_data : Void*, user_data_destroy : -> Void) : LibGdk::Atom*
  ...
  struct TextTag # object
    ...
    # Property accumulative-margin : Bool
    # Property background : UInt8*
    # Property background-full-height : Bool
    # Property background-full-height-set : Bool
    # Property background-gdk : LibGdk::Color
    # Property background-rgba : LibGdk::RGBA
    # Property background-set : Bool
    # Property direction : LibGtk::TextDirection
    ...
    # Property indent-set : Bool
    # Property invisible : Bool
    # Property invisible-set : Bool
    # Property justification : LibGtk::Justification
    # Property justification-set : Bool
    # Property language : UInt8*
    # Property language-set : Bool
    # Property left-margin : Int32
    # Property left-margin-set : Bool
    # Property name : UInt8*
    # Property paragraph-background : UInt8*
    # Property paragraph-background-gdk : LibGdk::Color
    # Property paragraph-background-rgba : LibGdk::RGBA
    # Property paragraph-background-set : Bool
    # Property pixels-above-lines : Int32
    # Property pixels-above-lines-set : Bool
    # Property pixels-below-lines : Int32
    # Property pixels-below-lines-set : Bool
    # Property pixels-inside-wrap : Int32
    # Property pixels-inside-wrap-set : Bool
    # Property right-margin : Int32
    # Property right-margin-set : Bool
    # Property rise : Int32
    # Property rise-set : Bool
    # Property scale : Float64
    # Property scale-set : Bool
  ...
  fun text_tag_table_foreach = gtk_text_tag_table_foreach(this : TextTagTable*, func : -> Void, data : Void*) : Void
  ...
  struct TextView # object
    ...
    # Property accepts-tab : Bool
    # Property buffer : LibGtk::TextBuffer
    # Property cursor-visible : Bool
    # Property editable : Bool
    # Property im-module : UInt8*
    # Property indent : Int32
    # Property input-hints : LibGtk::InputHints
  ...
  struct ToolButton # object
    ...
    # Property icon-name : UInt8*
    # Property icon-widget : LibGtk::Widget
    # Property label : UInt8*
    # Property label-widget : LibGtk::Widget
    # Property stock-id : UInt8*
    # Property use-underline : Bool
  ...
  struct ToolItemGroup # object
    ...
    # Property ellipsize : LibPango::EllipsizeMode
    # Property header-relief : LibGtk::ReliefStyle
    # Property label : UInt8*
    # Property label-widget : LibGtk::Widget
  end
  ...
  struct ToolPalette # object
    ...
    # Property icon-size : LibGtk::IconSize
    # Property icon-size-set : Bool
    # Property toolbar-style : LibGtk::ToolbarStyle
  end
  ...
  fun toolbar_set_drop_highlight_item = gtk_toolbar_set_drop_highlight_item(this : Toolbar*, tool_item : LibGtk::ToolItem*, index_ : Int32) : Void
  ...
  struct TreeModelFilter # object
    ...
    # Property child-model : LibGtk::TreeModel
    # Property virtual-root : LibGtk::TreePath
  ...
  fun tree_model_filter_set_modify_func = gtk_tree_model_filter_set_modify_func(this : TreeModelFilter*, n_columns : Int32, types : UInt64*, func : -> Void, data : Void*, destroy : -> Void) : Void
  fun tree_model_filter_set_visible_column = gtk_tree_model_filter_set_visible_column(this : TreeModelFilter*, column : Int32) : Void
  fun tree_model_filter_set_visible_func = gtk_tree_model_filter_set_visible_func(this : TreeModelFilter*, func : -> Void, data : Void*, destroy : -> Void) : Void
  ...
  fun tree_selection_selected_foreach = gtk_tree_selection_selected_foreach(this : TreeSelection*, func : -> Void, data : Void*) : Void
  fun tree_selection_set_mode = gtk_tree_selection_set_mode(this : TreeSelection*, type : LibGtk::SelectionMode) : Void
  fun tree_selection_set_select_function = gtk_tree_selection_set_select_function(this : TreeSelection*, func : -> Void, data : Void*, destroy : -> Void) : Void
  ...
  struct TreeView # object
    ...
    # Property activate-on-single-click : Bool
    # Property enable-grid-lines : LibGtk::TreeViewGridLines
    # Property enable-search : Bool
    # Property enable-tree-lines : Bool
    # Property expander-column : LibGtk::TreeViewColumn
    # Property fixed-height-mode : Bool
    # Property headers-clickable : Bool
    # Property headers-visible : Bool
    # Property hover-expand : Bool
    # Property hover-selection : Bool
    # Property level-indentation : Int32
    # Property model : LibGtk::TreeModel
    # Property reorderable : Bool
    # Property rubber-banding : Bool
    # Property rules-hint : Bool
    # Property search-column : Int32
    # Property show-expanders : Bool
    # Property tooltip-column : Int32
  ...
  fun tree_view_insert_column_with_data_func = gtk_tree_view_insert_column_with_data_func(this : TreeView*, position : Int32, title : UInt8*, cell : LibGtk::CellRenderer*, func : -> Void, data : Void*, dnotify : -> Void) : Int32
  ...
  fun tree_view_map_expanded_rows = gtk_tree_view_map_expanded_rows(this : TreeView*, func : -> Void, data : Void*) : Void
  ...
  fun tree_view_set_column_drag_function = gtk_tree_view_set_column_drag_function(this : TreeView*, func : -> Void, user_data : Void*, destroy : -> Void) : Void
  ...
  fun tree_view_set_destroy_count_func = gtk_tree_view_set_destroy_count_func(this : TreeView*, func : -> Void, data : Void*, destroy : -> Void) : Void
  ...
  fun tree_view_set_row_separator_func = gtk_tree_view_set_row_separator_func(this : TreeView*, func : -> Void, data : Void*, destroy : -> Void) : Void
  ...
  fun tree_view_set_search_equal_func = gtk_tree_view_set_search_equal_func(this : TreeView*, search_equal_func : -> Void, search_user_data : Void*, search_destroy : -> Void) : Void
  fun tree_view_set_search_position_func = gtk_tree_view_set_search_position_func(this : TreeView*, func : -> Void, data : Void*, destroy : -> Void) : Void
  ...
  struct TreeViewColumn # object
    ...
    # Property fixed-width : Int32
    # Property max-width : Int32
    # Property min-width : Int32
    # Property reorderable : Bool
    # Property resizable : Bool
    # Property sizing : LibGtk::TreeViewColumnSizing
    # Property sort-column-id : Int32
    # Property sort-indicator : Bool
    # Property sort-order : LibGtk::SortType
    # Property spacing : Int32
    # Property title : UInt8*
    # Property visible : Bool
    # Property widget : LibGtk::Widget
    # Property width : Int32
    # Property x-offset : Int32
    # Signal clicked
    # Virtual function clicked
  end
  ...
  fun tree_view_column_set_cell_data_func = gtk_tree_view_column_set_cell_data_func(this : TreeViewColumn*, cell_renderer : LibGtk::CellRenderer*, func : -> Void, func_data : Void*, destroy : -> Void) : Void
  ...
  struct Widget # object
    ...
    # Property app-paintable : Bool
    # Property can-default : Bool
    # Property can-focus : Bool
    # Property composite-child : Bool
    # Property double-buffered : Bool
    # Property events : LibGdk::EventMask
    # Property expand : Bool
    # Property halign : LibGtk::Align
    # Property has-default : Bool
    # Property has-focus : Bool
    # Property has-tooltip : Bool
    # Property height-request : Int32
    # Property hexpand : Bool
    # Property hexpand-set : Bool
    # Property is-focus : Bool
    # Property margin : Int32
    # Property margin-bottom : Int32
    # Property margin-end : Int32
    # Property margin-left : Int32
    # Property margin-right : Int32
    # Property margin-start : Int32
    # Property margin-top : Int32
    # Property name : UInt8*
    # Property no-show-all : Bool
    # Property opacity : Float64
    # Property parent : LibGtk::Container
    # Property receives-default : Bool
    ...
    # Property vexpand-set : Bool
    # Property visible : Bool
    # Property width-request : Int32
    # Property window : LibGdk::Window
  ...
  fun widget_add_tick_callback = gtk_widget_add_tick_callback(this : Widget*, callback : -> Void, user_data : Void*, notify : -> Void) : UInt32
  ...
  fun widget_drag_get_data = gtk_drag_get_data(this : Widget*, context : LibGdk::DragContext*, target : LibGdk::Atom*, time_ : UInt32) : Void
  ...
  struct Window # object
    ...
    # Property accept-focus : Bool
    # Property application : LibGtk::Application
    # Property attached-to : LibGtk::Widget
    # Property decorated : Bool
    # Property default-height : Int32
    # Property default-width : Int32
    # Property deletable : Bool
    # Property destroy-with-parent : Bool
    # Property focus-on-map : Bool
    # Property focus-visible : Bool
    # Property gravity : LibGdk::Gravity
    # Property has-resize-grip : Bool
    # Property has-toplevel-focus : Bool
    # Property hide-titlebar-when-maximized : Bool
    # Property icon : LibGdkPixbuf::Pixbuf
    # Property icon-name : UInt8*
    # Property is-active : Bool
    # Property is-maximized : Bool
    # Property mnemonics-visible : Bool
    # Property modal : Bool
    # Property resizable : Bool
    # Property resize-grip-visible : Bool
    # Property role : UInt8*
    # Property screen : LibGdk::Screen
    # Property skip-pager-hint : Bool
    # Property skip-taskbar-hint : Bool
    # Property startup-id : UInt8*
    # Property title : UInt8*
    # Property transient-for : LibGtk::Window
    # Property type : LibGtk::WindowType
    # Property type-hint : LibGdk::WindowTypeHint
    # Property urgency-hint : Bool
    # Property window-position : LibGtk::WindowPosition
  ...
  fun recent_info_get_application_info = gtk_recent_info_get_application_info(this : RecentInfo*, app_name : UInt8*, app_exec : UInt8**, count : UInt32*, time_ : Int64*) : Bool
  ...
  fun text_iter_backward_find_char = gtk_text_iter_backward_find_char(this : TextIter*, pred : -> Void, user_data : Void*, limit : LibGtk::TextIter*) : Bool
  ...
  fun text_iter_forward_find_char = gtk_text_iter_forward_find_char(this : TextIter*, pred : -> Void, user_data : Void*, limit : LibGtk::TextIter*) : Bool
  ...
  fun tree_path_append_index = gtk_tree_path_append_index(this : TreePath*, index_ : Int32) : Void
  ...
  fun tree_path_prepend_index = gtk_tree_path_prepend_index(this : TreePath*, index_ : Int32) : Void
  ...
  # Callback: AccelGroupActivate(accel_group : LibGtk::AccelGroup*, acceleratable : LibGObject::Object*, keyval : UInt32, modifier : LibGdk::ModifierType) : Bool
  # Callback: AccelGroupFindFunc(key : LibGtk::AccelKey*, closure : LibGObject::Closure*, data : Void*) : Bool
  # Callback: AccelMapForeach(data : Void*, accel_path : UInt8*, accel_key : UInt32, accel_mods : LibGdk::ModifierType, changed : Bool) : Void
  # Callback: AssistantPageFunc(current_page : Int32, data : Void*) : Int32
  # Callback: BuilderConnectFunc(builder : LibGtk::Builder*, object : LibGObject::Object*, signal_name : UInt8*, handler_name : UInt8*, connect_object : LibGObject::Object*, flags : LibGObject::ConnectFlags, user_data : Void*) : Void
  # Callback: CalendarDetailFunc(calendar : LibGtk::Calendar*, year : UInt32, month : UInt32, day : UInt32, user_data : Void*) : UInt8*
  # Callback: Callback(widget : LibGtk::Widget*, data : Void*) : Void
  # Callback: CellAllocCallback(renderer : LibGtk::CellRenderer*, cell_area : Libcairo::RectangleInt*, cell_background : Libcairo::RectangleInt*, data : Void*) : Bool
  # Callback: CellCallback(renderer : LibGtk::CellRenderer*, data : Void*) : Bool
  # Callback: CellLayoutDataFunc(cell_layout : LibGtk::CellLayout*, cell : LibGtk::CellRenderer*, tree_model : LibGtk::TreeModel*, iter : LibGtk::TreeIter*, data : Void*) : Void
  # Callback: ClipboardClearFunc(clipboard : LibGtk::Clipboard*, user_data_or_owner : Void*) : Void
  # Callback: ClipboardGetFunc(clipboard : LibGtk::Clipboard*, selection_data : LibGtk::SelectionData*, info : UInt32, user_data_or_owner : Void*) : Void
  # Callback: ClipboardImageReceivedFunc(clipboard : LibGtk::Clipboard*, pixbuf : LibGdkPixbuf::Pixbuf*, data : Void*) : Void
  # Callback: ClipboardReceivedFunc(clipboard : LibGtk::Clipboard*, selection_data : LibGtk::SelectionData*, data : Void*) : Void
  # Callback: ClipboardRichTextReceivedFunc(clipboard : LibGtk::Clipboard*, format : LibGdk::Atom*, text : UInt8*, length : UInt64, data : Void*) : Void
  # Callback: ClipboardTargetsReceivedFunc(clipboard : LibGtk::Clipboard*, atoms : LibGdk::Atom**, n_atoms : Int32, data : Void*) : Void
  # Callback: ClipboardTextReceivedFunc(clipboard : LibGtk::Clipboard*, text : UInt8*, data : Void*) : Void
  # Callback: ClipboardURIReceivedFunc(clipboard : LibGtk::Clipboard*, uris : UInt8**, data : Void*) : Void
  # Callback: ColorSelectionChangePaletteFunc(colors : LibGdk::Color*, n_colors : Int32) : Void
  # Callback: ColorSelectionChangePaletteWithScreenFunc(screen : LibGdk::Screen*, colors : LibGdk::Color*, n_colors : Int32) : Void
  # Callback: EntryCompletionMatchFunc(completion : LibGtk::EntryCompletion*, key : UInt8*, iter : LibGtk::TreeIter*, user_data : Void*) : Bool
  # Callback: FileFilterFunc(filter_info : LibGtk::FileFilterInfo*, data : Void*) : Bool
  # Callback: FlowBoxFilterFunc(child : LibGtk::FlowBoxChild*, user_data : Void*) : Bool
  # Callback: FlowBoxForeachFunc(box : LibGtk::FlowBox*, child : LibGtk::FlowBoxChild*, user_data : Void*) : Void
  # Callback: FlowBoxSortFunc(child1 : LibGtk::FlowBoxChild*, child2 : LibGtk::FlowBoxChild*, user_data : Void*) : Int32
  # Callback: FontFilterFunc(family : LibPango::FontFamily*, face : LibPango::FontFace*, data : Void*) : Bool
  # Callback: IconViewForeachFunc(icon_view : LibGtk::IconView*, path : LibGtk::TreePath*, data : Void*) : Void
  # Callback: KeySnoopFunc(grab_widget : LibGtk::Widget*, event : LibGdk::EventKey*, func_data : Void*) : Int32
  # Callback: ListBoxFilterFunc(row : LibGtk::ListBoxRow*, user_data : Void*) : Bool
  # Callback: ListBoxForeachFunc(box : LibGtk::ListBox*, row : LibGtk::ListBoxRow*, user_data : Void*) : Void
  # Callback: ListBoxSortFunc(row1 : LibGtk::ListBoxRow*, row2 : LibGtk::ListBoxRow*, user_data : Void*) : Int32
  # Callback: ListBoxUpdateHeaderFunc(row : LibGtk::ListBoxRow*, before : LibGtk::ListBoxRow*, user_data : Void*) : Void
  # Callback: MenuDetachFunc(attach_widget : LibGtk::Widget*, menu : LibGtk::Menu*) : Void
  # Callback: MenuPositionFunc(menu : LibGtk::Menu*, x : Int32*, y : Int32*, push_in : Bool*, user_data : Void*) : Void
  # Callback: ModuleDisplayInitFunc(display : LibGdk::Display*) : Void
  # Callback: ModuleInitFunc(argc : Int32*, argv : UInt8**) : Void
  # Callback: PageSetupDoneFunc(page_setup : LibGtk::PageSetup*, data : Void*) : Void
  # Callback: PrintSettingsFunc(key : UInt8*, value : UInt8*, user_data : Void*) : Void
  # Callback: RcPropertyParser(pspec : LibGObject::ParamSpec*, rc_string : LibGLib::String*, property_value : LibGObject::Value*) : Bool
  # Callback: RecentFilterFunc(filter_info : LibGtk::RecentFilterInfo*, user_data : Void*) : Bool
  # Callback: RecentSortFunc(a : LibGtk::RecentInfo*, b : LibGtk::RecentInfo*, user_data : Void*) : Int32
  # Callback: StylePropertyParser(string : UInt8*, value : LibGObject::Value*) : Bool
  # Callback: TextBufferDeserializeFunc(register_buffer : LibGtk::TextBuffer*, content_buffer : LibGtk::TextBuffer*, iter : LibGtk::TextIter*, data : UInt8*, length : UInt64, create_tags : Bool, user_data : Void*) : Bool
  # Callback: TextBufferSerializeFunc(register_buffer : LibGtk::TextBuffer*, content_buffer : LibGtk::TextBuffer*, start : LibGtk::TextIter*, end : LibGtk::TextIter*, length : UInt64*, user_data : Void*) : UInt8*
  # Callback: TextCharPredicate(ch : UInt8, user_data : Void*) : Bool
  # Callback: TextTagTableForeach(tag : LibGtk::TextTag*, data : Void*) : Void
  # Callback: TickCallback(widget : LibGtk::Widget*, frame_clock : LibGdk::FrameClock*, user_data : Void*) : Bool
  # Callback: TranslateFunc(path : UInt8*, func_data : Void*) : UInt8*
  # Callback: TreeCellDataFunc(tree_column : LibGtk::TreeViewColumn*, cell : LibGtk::CellRenderer*, tree_model : LibGtk::TreeModel*, iter : LibGtk::TreeIter*, data : Void*) : Void
  # Callback: TreeDestroyCountFunc(tree_view : LibGtk::TreeView*, path : LibGtk::TreePath*, children : Int32, user_data : Void*) : Void
  # Callback: TreeIterCompareFunc(model : LibGtk::TreeModel*, a : LibGtk::TreeIter*, b : LibGtk::TreeIter*, user_data : Void*) : Int32
  # Callback: TreeModelFilterModifyFunc(model : LibGtk::TreeModel*, iter : LibGtk::TreeIter*, value : LibGObject::Value*, column : Int32, data : Void*) : Void
  # Callback: TreeModelFilterVisibleFunc(model : LibGtk::TreeModel*, iter : LibGtk::TreeIter*, data : Void*) : Bool
  # Callback: TreeModelForeachFunc(model : LibGtk::TreeModel*, path : LibGtk::TreePath*, iter : LibGtk::TreeIter*, data : Void*) : Bool
  # Callback: TreeSelectionForeachFunc(model : LibGtk::TreeModel*, path : LibGtk::TreePath*, iter : LibGtk::TreeIter*, data : Void*) : Void
  # Callback: TreeSelectionFunc(selection : LibGtk::TreeSelection*, model : LibGtk::TreeModel*, path : LibGtk::TreePath*, path_currently_selected : Bool, data : Void*) : Bool
  # Callback: TreeViewColumnDropFunc(tree_view : LibGtk::TreeView*, column : LibGtk::TreeViewColumn*, prev_column : LibGtk::TreeViewColumn*, next_column : LibGtk::TreeViewColumn*, data : Void*) : Bool
  # Callback: TreeViewMappingFunc(tree_view : LibGtk::TreeView*, path : LibGtk::TreePath*, user_data : Void*) : Void
  # Callback: TreeViewRowSeparatorFunc(model : LibGtk::TreeModel*, iter : LibGtk::TreeIter*, data : Void*) : Bool
  # Callback: TreeViewSearchEqualFunc(model : LibGtk::TreeModel*, column : Int32, key : UInt8*, iter : LibGtk::TreeIter*, search_data : Void*) : Bool
  # Callback: TreeViewSearchPositionFunc(tree_view : LibGtk::TreeView*, search_dialog : LibGtk::Widget*, user_data : Void*) : Void
  ...
  # Requires Widget
    ...
    # Property create-folders : Bool
    # Property do-overwrite-confirmation : Bool
    # Property extra-widget : LibGtk::Widget
    # Property filter : LibGtk::FileFilter
    # Property local-only : Bool
    # Property preview-widget : LibGtk::Widget
    # Property preview-widget-active : Bool
    # Property select-multiple : Bool
    # Property show-hidden : Bool
    # Property use-preview-label : Bool
  ...
  struct FontChooser # interface
    ...
    # Property font-desc : LibPango::FontDescription
    # Property preview-text : UInt8*
    # Property show-preview-entry : Bool
  ...
  fun font_chooser_set_filter_func = gtk_font_chooser_set_filter_func(this : FontChooser*, filter : -> Void, user_data : Void*, destroy : -> Void) : Void
  ...
  struct RecentChooser # interface
    ...
    # Property local-only : Bool
    # Property recent-manager : LibGtk::RecentManager
    # Property select-multiple : Bool
    # Property show-icons : Bool
    # Property show-not-found : Bool
    # Property show-private : Bool
    # Property show-tips : Bool
    # Property sort-type : LibGtk::RecentSortType
    # Signal item-activated
    # Signal selection-changed
  ...
  fun recent_chooser_set_sort_func = gtk_recent_chooser_set_sort_func(this : RecentChooser*, sort_func : -> Void, sort_data : Void*, data_destroy : -> Void) : Void
  ...
  struct Scrollable # interface
    ...
    # Property vadjustment : LibGtk::Adjustment
    # Property vscroll-policy : LibGtk::ScrollablePolicy
  end
  ...
  fun tree_model_foreach = gtk_tree_model_foreach(this : TreeModel*, func : -> Void, user_data : Void*) : Void
  fun tree_model_get_column_type = gtk_tree_model_get_column_type(this : TreeModel*, index_ : Int32) : UInt64
  ...
  fun tree_sortable_set_default_sort_func = gtk_tree_sortable_set_default_sort_func(this : TreeSortable*, sort_func : -> Void, user_data : Void*, destroy : -> Void) : Void
  ...
  fun tree_sortable_set_sort_func = gtk_tree_sortable_set_sort_func(this : TreeSortable*, sort_column_id : Int32, sort_func : -> Void, user_data : Void*, destroy : -> Void) : Void
  ...
  fun icon_size_register_alias = gtk_icon_size_register_alias(alias : UInt8*, target : Int32) : Void
  ...
  fun drag_finish = gtk_drag_finish(context : LibGdk::DragContext*, success : Bool, del : Bool, time_ : UInt32) : Void
  ...
  fun paint_vline = gtk_paint_vline(style : LibGtk::Style*, cr : Libcairo::Context*, state_type : LibGtk::StateType, widget : LibGtk::Widget*, detail : UInt8*, y1_ : Int32, y2_ : Int32, x : Int32) : Void
  fun paper_size_get_default = gtk_paper_size_get_default() : UInt8*
  fun paper_size_get_paper_sizes = gtk_paper_size_get_paper_sizes(include_custom : Bool) : Void**
  ...
  fun print_run_page_setup_dialog_async = gtk_print_run_page_setup_dialog_async(parent : LibGtk::Window*, page_setup : LibGtk::PageSetup*, settings : LibGtk::PrintSettings*, done_cb : -> Void, data : Void*) : Void
  ...
  fun selection_convert = gtk_selection_convert(widget : LibGtk::Widget*, selection : LibGdk::Atom*, target : LibGdk::Atom*, time_ : UInt32) : Bool
  fun selection_owner_set = gtk_selection_owner_set(widget : LibGtk::Widget*, selection : LibGdk::Atom*, time_ : UInt32) : Bool
  fun selection_owner_set_for_display = gtk_selection_owner_set_for_display(display : LibGdk::Display*, widget : LibGtk::Widget*, selection : LibGdk::Atom*, time_ : UInt32) : Bool
  ...
  fun stock_set_translate_func = gtk_stock_set_translate_func(domain : UInt8*, func : -> Void, data : Void*, notify : -> Void) : Void

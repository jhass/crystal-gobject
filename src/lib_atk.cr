...
lib LibAtk
  ...
  fun text_attribute_get_value = atk_text_attribute_get_value(attr : LibAtk::TextAttribute, index_ : Int32) : UInt8*
  ...
  # Callback: EventListener(obj : LibAtk::Object*) : Void
  # Callback: EventListenerInit() : Void
  # Callback: FocusHandler(object : LibAtk::Object*, focus_in : Bool) : Void
  # Callback: Function(user_data : Void*) : Bool
  # Callback: KeySnoopFunc(event : LibAtk::KeyEventStruct*, user_data : Void*) : Int32
  # Callback: PropertyChangeHandler(obj : LibAtk::Object*, vals : LibAtk::PropertyValues*) : Void
  ...
  struct Object # object
    ...
    # Property accessible-description : UInt8*
    # Property accessible-hypertext-nlinks : Int32
    # Property accessible-name : UInt8*
    # Property accessible-parent : LibAtk::Object
    # Property accessible-role : Int32
    # Property accessible-table-caption : UInt8*
    # Property accessible-table-caption-object : LibAtk::Object
    # Property accessible-table-column-description : UInt8*
    # Property accessible-table-column-header : LibAtk::Object
    # Property accessible-table-row-description : UInt8*
  ...
  fun object_initialize = atk_object_initialize(this : Object*, data : Void*) : Void

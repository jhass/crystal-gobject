...
lib LibGObject
  ...
  # Callback: BaseFinalizeFunc(g_class : Void*) : Void
  # Callback: BaseInitFunc(g_class : Void*) : Void
  # Callback: BindingTransformFunc(binding : LibGObject::Binding*, from_value : LibGObject::Value*, to_value : LibGObject::Value*, user_data : Void*) : Bool
  # Callback: BoxedFreeFunc(boxed : Void*) : Void
  # Callback: Callback() : Void
  # Callback: ClassFinalizeFunc(g_class : Void*, class_data : Void*) : Void
  # Callback: ClassInitFunc(g_class : Void*, class_data : Void*) : Void
  # Callback: ClosureMarshal(closure : LibGObject::Closure*, return_value : LibGObject::Value*, n_param_values : UInt32, param_values : LibGObject::Value*, invocation_hint : Void*, marshal_data : Void*) : Void
  # Callback: ClosureNotify(data : Void*, closure : LibGObject::Closure*) : Void
  # Callback: InstanceInitFunc(instance : LibGObject::TypeInstance*, g_class : Void*) : Void
  # Callback: InterfaceFinalizeFunc(g_iface : Void*, iface_data : Void*) : Void
  # Callback: InterfaceInitFunc(g_iface : Void*, iface_data : Void*) : Void
  # Callback: ObjectFinalizeFunc(object : LibGObject::Object*) : Void
  # Callback: ObjectGetPropertyFunc(object : LibGObject::Object*, property_id : UInt32, value : LibGObject::Value*, pspec : LibGObject::ParamSpec*) : Void
  # Callback: ObjectSetPropertyFunc(object : LibGObject::Object*, property_id : UInt32, value : LibGObject::Value*, pspec : LibGObject::ParamSpec*) : Void
  # Callback: SignalAccumulator(ihint : LibGObject::SignalInvocationHint*, return_accu : LibGObject::Value*, handler_return : LibGObject::Value*, data : Void*) : Bool
  # Callback: SignalEmissionHook(ihint : LibGObject::SignalInvocationHint*, n_param_values : UInt32, param_values : LibGObject::Value*, data : Void*) : Bool
  # Callback: ToggleNotify(data : Void*, object : LibGObject::Object*, is_last_ref : Bool) : Void
  # Callback: TypeClassCacheFunc(cache_data : Void*, g_class : LibGObject::TypeClass*) : Bool
  # Callback: TypeInterfaceCheckFunc(check_data : Void*, g_iface : Void*) : Void
  # Callback: TypePluginCompleteInterfaceInfo(plugin : LibGObject::TypePlugin*, instance_type : UInt64, interface_type : UInt64, info : LibGObject::InterfaceInfo*) : Void
  # Callback: TypePluginCompleteTypeInfo(plugin : LibGObject::TypePlugin*, g_type : UInt64, info : LibGObject::TypeInfo*, value_table : LibGObject::TypeValueTable*) : Void
  # Callback: TypePluginUnuse(plugin : LibGObject::TypePlugin*) : Void
  # Callback: TypePluginUse(plugin : LibGObject::TypePlugin*) : Void
  # Callback: ValueTransform(src_value : LibGObject::Value*, dest_value : LibGObject::Value*) : Void
  # Callback: WeakNotify(data : Void*, where_the_object_was : LibGObject::Object*) : Void
  ...
  fun value_array_get_nth = g_value_array_get_nth(this : ValueArray*, index_ : UInt32) : LibGObject::Value*

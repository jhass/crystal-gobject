...
lib LibGdk
  ...
  # Callback: EventFunc(event : LibGdk::Event*, data : Void*) : Void
  # Callback: FilterFunc(xevent : Void*, event : LibGdk::Event*, data : Void*) : LibGdk::FilterReturn
  # Callback: WindowChildFunc(window : LibGdk::Window*, user_data : Void*) : Bool
  # Callback: WindowInvalidateHandlerFunc(window : LibGdk::Window*, region : Libcairo::Region*) : Void
  ...
  fun drag_abort = gdk_drag_abort(context : LibGdk::DragContext*, time_ : UInt32) : Void
  ...
  fun drag_drop = gdk_drag_drop(context : LibGdk::DragContext*, time_ : UInt32) : Void
  ...
  fun drag_motion = gdk_drag_motion(context : LibGdk::DragContext*, dest_window : LibGdk::Window*, protocol : LibGdk::DragProtocol, x_root : Int32, y_root : Int32, suggested_action : LibGdk::DragAction, possible_actions : LibGdk::DragAction, time_ : UInt32) : Bool
  fun drag_status = gdk_drag_status(context : LibGdk::DragContext*, action : LibGdk::DragAction, time_ : UInt32) : Void
  fun drop_finish = gdk_drop_finish(context : LibGdk::DragContext*, success : Bool, time_ : UInt32) : Void
  fun drop_reply = gdk_drop_reply(context : LibGdk::DragContext*, accepted : Bool, time_ : UInt32) : Void
  ...
  fun selection_convert = gdk_selection_convert(requestor : LibGdk::Window*, selection : LibGdk::Atom*, target : LibGdk::Atom*, time_ : UInt32) : Void
  ...
  fun selection_owner_set = gdk_selection_owner_set(owner : LibGdk::Window*, selection : LibGdk::Atom*, time_ : UInt32, send_event : Bool) : Bool
  fun selection_owner_set_for_display = gdk_selection_owner_set_for_display(display : LibGdk::Display*, owner : LibGdk::Window*, selection : LibGdk::Atom*, time_ : UInt32, send_event : Bool) : Bool
  fun selection_send_notify = gdk_selection_send_notify(requestor : LibGdk::Window*, selection : LibGdk::Atom*, target : LibGdk::Atom*, property : LibGdk::Atom*, time_ : UInt32) : Void
  fun selection_send_notify_for_display = gdk_selection_send_notify_for_display(display : LibGdk::Display*, requestor : LibGdk::Window*, selection : LibGdk::Atom*, target : LibGdk::Atom*, property : LibGdk::Atom*, time_ : UInt32) : Void

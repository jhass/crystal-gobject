...
module Gst
  class GhostPad < ProxyPad
    ...
    def self.activate_mode_default(pad, parent, mode, active)
      __return_value = LibGst.ghost_pad_activate_mode_default((pad.to_unsafe as LibGst::Pad*), parent && (parent.to_unsafe as LibGst::Object*), mode, Bool.cast(active))
      __return_value
    end

    def self.internal_activate_mode_default(pad, parent, mode, active)
      __return_value = LibGst.ghost_pad_internal_activate_mode_default((pad.to_unsafe as LibGst::Pad*), parent && (parent.to_unsafe as LibGst::Object*), mode, Bool.cast(active))
      __return_value
    end

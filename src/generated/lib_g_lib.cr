...
lib LibGLib
 ...
 type ChildWatchFunc = Int32, Int32, Void* -> Void
 type CompareDataFunc = Void*, Void*, Void* -> Int32
 type CompareFunc = Void*, Void* -> Int32
 type DataForeachFunc = UInt32, Void*, Void* -> Void
 type DestroyNotify = Void* -> Void
 type EqualFunc = Void*, Void* -> Bool
 type FreeFunc = Void* -> Void
 type Func = Void*, Void* -> Void
 type HFunc = Void*, Void*, Void* -> Void
 type HRFunc = Void*, Void*, Void* -> Bool
 type HashFunc = Void* -> UInt32
 type HookCheckFunc = Void* -> Bool
 type HookCheckMarshaller = LibGLib::Hook*, Void* -> Bool
 type HookCompareFunc = LibGLib::Hook*, LibGLib::Hook* -> Int32
 type HookFinalizeFunc = LibGLib::HookList*, LibGLib::Hook* -> Void
 type HookFindFunc = LibGLib::Hook*, Void* -> Bool
 type HookFunc = Void* -> Void
 type HookMarshaller = LibGLib::Hook*, Void* -> Void
 type IOFunc = LibGLib::IOChannel*, LibGLib::IOCondition, Void* -> Bool
 type LogFunc = UInt8*, LibGLib::LogLevelFlags, UInt8*, Void* -> Void
 type NodeForeachFunc = LibGLib::Node*, Void* -> Void
 type NodeTraverseFunc = LibGLib::Node*, Void* -> Bool
 type OptionArgFunc = UInt8*, UInt8*, Void* -> Bool
 type OptionErrorFunc = LibGLib::OptionContext*, LibGLib::OptionGroup*, Void* -> Void
 type OptionParseFunc = LibGLib::OptionContext*, LibGLib::OptionGroup*, Void* -> Bool
 type PollFunc = LibGLib::PollFD*, UInt32, Int32 -> Int32
 type PrintFunc = UInt8* -> Void
 type RegexEvalCallback = LibGLib::MatchInfo*, LibGLib::String*, Void* -> Bool
 type ScannerMsgFunc = LibGLib::Scanner*, UInt8*, Bool -> Void
 type SequenceIterCompareFunc = LibGLib::SequenceIter*, LibGLib::SequenceIter*, Void* -> Int32
 type SourceDummyMarshal =  -> Void
 type SourceFunc = Void* -> Bool
 type SpawnChildSetupFunc = Void* -> Void
 type TestDataFunc = Void* -> Void
 type TestFixtureFunc = Void*, Void* -> Void
 type TestFunc =  -> Void
 type TestLogFatalFunc = UInt8*, LibGLib::LogLevelFlags, UInt8*, Void* -> Bool
 type TranslateFunc = UInt8*, Void* -> UInt8*
 type TraverseFunc = Void*, Void*, Void* -> Bool
 type UnixFDSourceFunc = Int32, LibGLib::IOCondition, Void* -> Bool
 type VoidFunc =  -> Void
end

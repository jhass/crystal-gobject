module Pango
  class Font < GObject::Object
    ...
    def self.descriptions_free(descs, n_descs)
      __return_value = LibPango.font_descriptions_free(descs, Int32.cast(n_descs))
      __return_value
    end
    ...
    def metrics(language)
      __return_value = LibPango.font_get_metrics((to_unsafe as LibPango::Font*), (language.to_unsafe as LibPango::Language*))

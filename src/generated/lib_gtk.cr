...
lib LibGtk
 ...
 type AccelGroupActivate = LibGtk::AccelGroup*, LibGObject::Object*, UInt32, LibGdk::ModifierType -> Bool
 type AccelGroupFindFunc = LibGtk::AccelKey*, LibGObject::Closure*, Void* -> Bool
 type AccelMapForeach = Void*, UInt8*, UInt32, LibGdk::ModifierType, Bool -> Void
 type AssistantPageFunc = Int32, Void* -> Int32
 type BuilderConnectFunc = LibGtk::Builder*, LibGObject::Object*, UInt8*, UInt8*, LibGObject::Object*, LibGObject::ConnectFlags, Void* -> Void
 type CalendarDetailFunc = LibGtk::Calendar*, UInt32, UInt32, UInt32, Void* -> UInt8*
 type Callback = LibGtk::Widget*, Void* -> Void
 type CellAllocCallback = LibGtk::CellRenderer*, Libcairo::RectangleInt*, Libcairo::RectangleInt*, Void* -> Bool
 type CellCallback = LibGtk::CellRenderer*, Void* -> Bool
 type CellLayoutDataFunc = LibGtk::CellLayout*, LibGtk::CellRenderer*, LibGtk::TreeModel*, LibGtk::TreeIter*, Void* -> Void
 type ClipboardClearFunc = LibGtk::Clipboard*, Void* -> Void
 type ClipboardGetFunc = LibGtk::Clipboard*, LibGtk::SelectionData*, UInt32, Void* -> Void
 type ClipboardImageReceivedFunc = LibGtk::Clipboard*, LibGdkPixbuf::Pixbuf*, Void* -> Void
 type ClipboardReceivedFunc = LibGtk::Clipboard*, LibGtk::SelectionData*, Void* -> Void
 type ClipboardRichTextReceivedFunc = LibGtk::Clipboard*, LibGdk::Atom*, UInt8*, UInt64, Void* -> Void
 type ClipboardTargetsReceivedFunc = LibGtk::Clipboard*, LibGdk::Atom**, Int32, Void* -> Void
 type ClipboardTextReceivedFunc = LibGtk::Clipboard*, UInt8*, Void* -> Void
 type ClipboardURIReceivedFunc = LibGtk::Clipboard*, UInt8**, Void* -> Void
 type ColorSelectionChangePaletteFunc = LibGdk::Color*, Int32 -> Void
 type ColorSelectionChangePaletteWithScreenFunc = LibGdk::Screen*, LibGdk::Color*, Int32 -> Void
 type EntryCompletionMatchFunc = LibGtk::EntryCompletion*, UInt8*, LibGtk::TreeIter*, Void* -> Bool
 type FileFilterFunc = LibGtk::FileFilterInfo*, Void* -> Bool
 type FlowBoxFilterFunc = LibGtk::FlowBoxChild*, Void* -> Bool
 type FlowBoxForeachFunc = LibGtk::FlowBox*, LibGtk::FlowBoxChild*, Void* -> Void
 type FlowBoxSortFunc = LibGtk::FlowBoxChild*, LibGtk::FlowBoxChild*, Void* -> Int32
 type FontFilterFunc = LibPango::FontFamily*, LibPango::FontFace*, Void* -> Bool
 type IconViewForeachFunc = LibGtk::IconView*, LibGtk::TreePath*, Void* -> Void
 type KeySnoopFunc = LibGtk::Widget*, LibGdk::EventKey*, Void* -> Int32
 type ListBoxCreateWidgetFunc = LibGObject::Object*, Void* -> LibGtk::Widget*
 type ListBoxFilterFunc = LibGtk::ListBoxRow*, Void* -> Bool
 type ListBoxForeachFunc = LibGtk::ListBox*, LibGtk::ListBoxRow*, Void* -> Void
 type ListBoxSortFunc = LibGtk::ListBoxRow*, LibGtk::ListBoxRow*, Void* -> Int32
 type ListBoxUpdateHeaderFunc = LibGtk::ListBoxRow*, LibGtk::ListBoxRow*, Void* -> Void
 type MenuDetachFunc = LibGtk::Widget*, LibGtk::Menu* -> Void
 type MenuPositionFunc = LibGtk::Menu*, Int32, Int32, Bool, Void* -> Void
 type ModuleDisplayInitFunc = LibGdk::Display* -> Void
 type ModuleInitFunc = Int32*, UInt8** -> Void
 type PageSetupDoneFunc = LibGtk::PageSetup*, Void* -> Void
 type PrintSettingsFunc = UInt8*, UInt8*, Void* -> Void
 type RcPropertyParser = LibGObject::ParamSpec*, LibGLib::String*, LibGObject::Value* -> Bool
 type RecentFilterFunc = LibGtk::RecentFilterInfo*, Void* -> Bool
 type RecentSortFunc = LibGtk::RecentInfo*, LibGtk::RecentInfo*, Void* -> Int32
 type StylePropertyParser = UInt8*, LibGObject::Value* -> Bool
 type TextBufferDeserializeFunc = LibGtk::TextBuffer*, LibGtk::TextBuffer*, LibGtk::TextIter*, UInt8*, UInt64, Bool, Void* -> Bool
 type TextBufferSerializeFunc = LibGtk::TextBuffer*, LibGtk::TextBuffer*, LibGtk::TextIter*, LibGtk::TextIter*, UInt64*, Void* -> UInt8*
 type TextCharPredicate = UInt8, Void* -> Bool
 type TextTagTableForeach = LibGtk::TextTag*, Void* -> Void
 type TickCallback = LibGtk::Widget*, LibGdk::FrameClock*, Void* -> Bool
 type TranslateFunc = UInt8*, Void* -> UInt8*
 type TreeCellDataFunc = LibGtk::TreeViewColumn*, LibGtk::CellRenderer*, LibGtk::TreeModel*, LibGtk::TreeIter*, Void* -> Void
 type TreeDestroyCountFunc = LibGtk::TreeView*, LibGtk::TreePath*, Int32, Void* -> Void
 type TreeIterCompareFunc = LibGtk::TreeModel*, LibGtk::TreeIter*, LibGtk::TreeIter*, Void* -> Int32
 type TreeModelFilterModifyFunc = LibGtk::TreeModel*, LibGtk::TreeIter*, LibGObject::Value, Int32, Void* -> Void
 type TreeModelFilterVisibleFunc = LibGtk::TreeModel*, LibGtk::TreeIter*, Void* -> Bool
 type TreeModelForeachFunc = LibGtk::TreeModel*, LibGtk::TreePath*, LibGtk::TreeIter*, Void* -> Bool
 type TreeSelectionForeachFunc = LibGtk::TreeModel*, LibGtk::TreePath*, LibGtk::TreeIter*, Void* -> Void
 type TreeSelectionFunc = LibGtk::TreeSelection*, LibGtk::TreeModel*, LibGtk::TreePath*, Bool, Void* -> Bool
 type TreeViewColumnDropFunc = LibGtk::TreeView*, LibGtk::TreeViewColumn*, LibGtk::TreeViewColumn*, LibGtk::TreeViewColumn*, Void* -> Bool
 type TreeViewMappingFunc = LibGtk::TreeView*, LibGtk::TreePath*, Void* -> Void
 type TreeViewRowSeparatorFunc = LibGtk::TreeModel*, LibGtk::TreeIter*, Void* -> Bool
 type TreeViewSearchEqualFunc = LibGtk::TreeModel*, Int32, UInt8*, LibGtk::TreeIter*, Void* -> Bool
 type TreeViewSearchPositionFunc = LibGtk::TreeView*, LibGtk::Widget*, Void* -> Void
end

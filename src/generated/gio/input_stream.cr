module Gio
  class InputStream < GObject::Object
    ...
    def close(cancellable)
      ...
      __return_value = LibGio.input_stream_close((to_unsafe as LibGio::InputStream*), (cancellable.to_unsafe as LibGio::Cancellable*), pointerof(__error))
      GLib::Error.assert __error
      __return_value
    end

    def close_async(io_priority, cancellable, callback, user_data)
      __return_value = LibGio.input_stream_close_async((to_unsafe as LibGio::InputStream*), Int32.cast(io_priority), (cancellable.to_unsafe as LibGio::Cancellable*), callback, user_data)
      __return_value
    end
    ...
    def read(buffer, count, cancellable)
      __error = Pointer(LibGLib::Error).null
      __return_value = LibGio.input_stream_read((to_unsafe as LibGio::InputStream*), buffer, UInt64.cast(count), (cancellable.to_unsafe as LibGio::Cancellable*), pointerof(__error))
      GLib::Error.assert __error
      __return_value
    end
    ...
    def read_all(buffer, count, bytes_read, cancellable)
      __error = Pointer(LibGLib::Error).null
      __return_value = LibGio.input_stream_read_all((to_unsafe as LibGio::InputStream*), buffer, UInt64.cast(count), UInt64.cast(bytes_read), (cancellable.to_unsafe as LibGio::Cancellable*), pointerof(__error))
      GLib::Error.assert __error
      __return_value
    end

    def read_async(buffer, count, io_priority, cancellable, callback, user_data)
      __return_value = LibGio.input_stream_read_async((to_unsafe as LibGio::InputStream*), buffer, UInt64.cast(count), Int32.cast(io_priority), (cancellable.to_unsafe as LibGio::Cancellable*), callback, user_data)
      __return_value
    end

    def read_bytes(count, cancellable)
      __error = Pointer(LibGLib::Error).null
      __return_value = LibGio.input_stream_read_bytes((to_unsafe as LibGio::InputStream*), UInt64.cast(count), (cancellable.to_unsafe as LibGio::Cancellable*), pointerof(__error))
      GLib::Error.assert __error
      GLib::Bytes.new(__return_value)
    end

    def read_bytes_async(count, io_priority, cancellable, callback, user_data)
      __return_value = LibGio.input_stream_read_bytes_async((to_unsafe as LibGio::InputStream*), UInt64.cast(count), Int32.cast(io_priority), (cancellable.to_unsafe as LibGio::Cancellable*), callback, user_data)
      __return_value
    end
    ...
    def skip(count, cancellable)
      __error = Pointer(LibGLib::Error).null
      __return_value = LibGio.input_stream_skip((to_unsafe as LibGio::InputStream*), UInt64.cast(count), (cancellable.to_unsafe as LibGio::Cancellable*), pointerof(__error))
      GLib::Error.assert __error
      __return_value
    end

    def skip_async(count, io_priority, cancellable, callback, user_data)
      __return_value = LibGio.input_stream_skip_async((to_unsafe as LibGio::InputStream*), UInt64.cast(count), Int32.cast(io_priority), (cancellable.to_unsafe as LibGio::Cancellable*), callback, user_data)
      __return_value
    end

module Gio
  module ProxyResolver
    ...
    def lookup(uri, cancellable)
      ...
      __return_value = LibGio.proxy_resolver_lookup(to_unsafe.as(LibGio::ProxyResolver*), uri.to_unsafe, cancellable && cancellable.to_unsafe.as(LibGio::Cancellable*), pointerof(__error))

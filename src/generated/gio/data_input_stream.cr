...
module Gio
  class DataInputStream < BufferedInputStream
    ...
    def newline_type
      gvalue = GObject::Value.new(GObject::Type::INTERFACE)
      LibGObject.object_get_property(@pointer.as(LibGObject::Object*), "newline_type", gvalue)
      gvalue.enum
    end
    ...
    def read_int16(cancellable) # function
      __error = Pointer(LibGLib::Error).null
    ...
    def read_int32(cancellable) # function
      __error = Pointer(LibGLib::Error).null
    ...
    def read_int64(cancellable) # function
      __error = Pointer(LibGLib::Error).null
    ...
    def read_line(length, cancellable) # function
      __error = Pointer(LibGLib::Error).null
    ...
    def read_line_finish(result, length) # function
      __error = Pointer(LibGLib::Error).null
    ...
    def read_line_finish_utf8(result, length) # function
      __error = Pointer(LibGLib::Error).null
    ...
    def read_line_utf8(length, cancellable) # function
      __error = Pointer(LibGLib::Error).null
    ...
    def read_uint16(cancellable) # function
      __error = Pointer(LibGLib::Error).null
    ...
    def read_uint32(cancellable) # function
      __error = Pointer(LibGLib::Error).null
    ...
    def read_uint64(cancellable) # function
      __error = Pointer(LibGLib::Error).null
    ...
    def read_until(stop_chars, length, cancellable) # function
      __error = Pointer(LibGLib::Error).null
    ...
    def read_until_finish(result, length) # function
      __error = Pointer(LibGLib::Error).null
    ...
    def read_upto(stop_chars, stop_chars_len, length, cancellable) # function
      __error = Pointer(LibGLib::Error).null
    ...
    def read_upto_finish(result, length) # function
      __error = Pointer(LibGLib::Error).null

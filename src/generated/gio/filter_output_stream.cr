...
module Gio
  class FilterOutputStream < OutputStream
    @gio_filter_output_stream : LibGio::FilterOutputStream*?
    def initialize(@gio_filter_output_stream : LibGio::FilterOutputStream*)
    end
    ...
    def close_base_stream=(close_base)
      LibGio.filter_output_stream_set_close_base_stream(to_unsafe.as(LibGio::FilterOutputStream*), close_base)
      nil
    end

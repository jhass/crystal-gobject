module Gio
  module ActionGroup
    ...
    def activate_action(action_name, parameter)
      __return_value = LibGio.action_group_activate_action(to_unsafe.as(LibGio::ActionGroup*), action_name.to_unsafe, parameter && parameter.to_unsafe.as(LibGLib::Variant*))
      __return_value
    end
    ...
    def action_enabled(action_name)
      __return_value = LibGio.action_group_get_action_enabled(to_unsafe.as(LibGio::ActionGroup*), action_name.to_unsafe)
      __return_value
    end

    def action_parameter_type(action_name)
      __return_value = LibGio.action_group_get_action_parameter_type(to_unsafe.as(LibGio::ActionGroup*), action_name.to_unsafe)
      GLib::VariantType.new(__return_value) if __return_value
    end

    def action_state(action_name)
      __return_value = LibGio.action_group_get_action_state(to_unsafe.as(LibGio::ActionGroup*), action_name.to_unsafe)
      GLib::Variant.new(__return_value) if __return_value
    end

    def action_state_hint(action_name)
      __return_value = LibGio.action_group_get_action_state_hint(to_unsafe.as(LibGio::ActionGroup*), action_name.to_unsafe)
      GLib::Variant.new(__return_value) if __return_value
    end

    def action_state_type(action_name)
      __return_value = LibGio.action_group_get_action_state_type(to_unsafe.as(LibGio::ActionGroup*), action_name.to_unsafe)
      GLib::VariantType.new(__return_value) if __return_value
    end

    def has_action(action_name)
      __return_value = LibGio.action_group_has_action(to_unsafe.as(LibGio::ActionGroup*), action_name.to_unsafe)
      __return_value
    end

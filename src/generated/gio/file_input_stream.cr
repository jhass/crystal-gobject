...
module Gio
  class FileInputStream < InputStream
    ...
    def query_info_async(attributes, io_priority, cancellable, callback, user_data)
      __return_value = LibGio.file_input_stream_query_info_async(to_unsafe.as(LibGio::FileInputStream*), attributes, Int32.new(io_priority), cancellable && cancellable.to_unsafe.as(LibGio::Cancellable*), callback && callback, user_data && user_data)
      __return_value
    end

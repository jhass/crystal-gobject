module Gio
  module Proxy
    ...
    def connect(connection, proxy_address, cancellable)
      ...
      __return_value = LibGio.proxy_connect(to_unsafe.as(LibGio::Proxy*), connection.to_unsafe.as(LibGio::IOStream*), proxy_address.to_unsafe.as(LibGio::ProxyAddress*), cancellable ? cancellable.to_unsafe.as(LibGio::Cancellable*) : nil, pointerof(__error))

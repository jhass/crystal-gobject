module Gio
  module Proxy
    ...
    def connect(connection, proxy_address, cancellable)
      ...
      __return_value = LibGio.proxy_connect((to_unsafe as LibGio::Proxy*), (connection.to_unsafe as LibGio::IOStream*), (proxy_address.to_unsafe as LibGio::ProxyAddress*), (cancellable.to_unsafe as LibGio::Cancellable*), pointerof(__error))
      GLib::Error.assert __error
      Gio::IOStream.new(__return_value)
    end

    def connect_async(connection, proxy_address, cancellable, callback, user_data)
      __return_value = LibGio.proxy_connect_async((to_unsafe as LibGio::Proxy*), (connection.to_unsafe as LibGio::IOStream*), (proxy_address.to_unsafe as LibGio::ProxyAddress*), (cancellable.to_unsafe as LibGio::Cancellable*), callback, user_data)
      __return_value
    end

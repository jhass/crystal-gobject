module Gio
  module LoadableIcon
    def load(size, type, cancellable)
      ...
      __return_value = LibGio.loadable_icon_load((to_unsafe as LibGio::LoadableIcon*), Int32.cast(size), type, cancellable && (cancellable.to_unsafe as LibGio::Cancellable*), pointerof(__error))

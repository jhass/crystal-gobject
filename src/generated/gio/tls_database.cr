module Gio
  class TlsDatabase < GObject::Object
    ...
    def lookup_certificate_for_handle(handle, interaction, flags : Gio::TlsDatabaseLookupFlags, cancellable) # function
    ...
    def lookup_certificate_for_handle_finish(result) # function
      __error = Pointer(LibGLib::Error).null
    ...
    def lookup_certificate_issuer(certificate, interaction, flags : Gio::TlsDatabaseLookupFlags, cancellable) # function
      __error = Pointer(LibGLib::Error).null
    ...
    def lookup_certificate_issuer_finish(result) # function
      __error = Pointer(LibGLib::Error).null
    ...
    def lookup_certificates_issued_by(issuer_raw_dn, interaction, flags : Gio::TlsDatabaseLookupFlags, cancellable) # function
      __error = Pointer(LibGLib::Error).null
    ...
    def lookup_certificates_issued_by_finish(result) # function
      __error = Pointer(LibGLib::Error).null
    ...
    def verify_chain(chain, purpose, identity, interaction, flags : Gio::TlsDatabaseVerifyFlags, cancellable) # function
      __error = Pointer(LibGLib::Error).null
    ...
    def verify_chain_finish(result) # function
      __error = Pointer(LibGLib::Error).null

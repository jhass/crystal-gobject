module Gio
  class TlsDatabase < GObject::Object
    ...
    def lookup_certificate_for_handle(handle, interaction, flags : Gio::TlsDatabaseLookupFlags, cancellable)
      ...
      __return_value = LibGio.tls_database_lookup_certificate_for_handle(to_unsafe.as(LibGio::TlsDatabase*), handle.to_unsafe, interaction ? interaction.to_unsafe.as(LibGio::TlsInteraction*) : nil, flags, cancellable ? cancellable.to_unsafe.as(LibGio::Cancellable*) : nil, pointerof(__error))
    ...
    def lookup_certificate_issuer(certificate, interaction, flags : Gio::TlsDatabaseLookupFlags, cancellable)
      __error = Pointer(LibGLib::Error).null
      __return_value = LibGio.tls_database_lookup_certificate_issuer(to_unsafe.as(LibGio::TlsDatabase*), certificate.to_unsafe.as(LibGio::TlsCertificate*), interaction ? interaction.to_unsafe.as(LibGio::TlsInteraction*) : nil, flags, cancellable ? cancellable.to_unsafe.as(LibGio::Cancellable*) : nil, pointerof(__error))
      GLib::Error.assert __error
      Gio::TlsCertificate.new(__return_value)
    end
    ...
    def lookup_certificates_issued_by(issuer_raw_dn, interaction, flags : Gio::TlsDatabaseLookupFlags, cancellable)
      __error = Pointer(LibGLib::Error).null
      __return_value = LibGio.tls_database_lookup_certificates_issued_by(to_unsafe.as(LibGio::TlsDatabase*), issuer_raw_dn, interaction ? interaction.to_unsafe.as(LibGio::TlsInteraction*) : nil, flags, cancellable ? cancellable.to_unsafe.as(LibGio::Cancellable*) : nil, pointerof(__error))
      GLib::Error.assert __error

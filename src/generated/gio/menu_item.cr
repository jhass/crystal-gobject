module Gio
  class MenuItem < GObject::Object
    ...
    def set_action_and_target_value(action, target_value)
      __return_value = LibGio.menu_item_set_action_and_target_value(to_unsafe.as(LibGio::MenuItem*), action, target_value && target_value.to_unsafe.as(LibGLib::Variant*))
      __return_value
    end

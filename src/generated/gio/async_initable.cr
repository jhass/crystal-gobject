module Gio
  module AsyncInitable
    ...
    def init_async(io_priority, cancellable, callback, user_data)
      LibGio.async_initable_init_async(to_unsafe.as(LibGio::AsyncInitable*), Int32.new(io_priority), cancellable ? cancellable.to_unsafe.as(LibGio::Cancellable*) : nil, callback ? callback : nil, user_data ? user_data : nil)
      nil
    end

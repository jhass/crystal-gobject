...
module Gio
  class TcpConnection < SocketConnection
    ...
    def graceful_disconnect=(__value)
      LibGio.tcp_connection_set_graceful_disconnect((to_unsafe as LibGio::TcpConnection*), Bool.cast(__value))
    end
    ...
    def graceful_disconnect=(graceful_disconnect)
      __return_value = LibGio.tcp_connection_set_graceful_disconnect((to_unsafe as LibGio::TcpConnection*), Bool.cast(graceful_disconnect))
      __return_value
    end

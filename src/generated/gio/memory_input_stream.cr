...
module Gio
  class MemoryInputStream < InputStream
    ...
    def self.new_from_data(data, len, destroy)
      __return_value = LibGio.memory_input_stream_new_from_data(data, Int64.cast(len), destroy)
      Gio::InputStream.new(__return_value)
    end
    ...
    def add_data(data, len, destroy)
      __return_value = LibGio.memory_input_stream_add_data((to_unsafe as LibGio::MemoryInputStream*), data, Int64.cast(len), destroy)
      __return_value
    end

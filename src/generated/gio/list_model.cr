module Gio
  module ListModel
    ...
    def item(position)
      __return_value = LibGio.list_model_get_item((to_unsafe as LibGio::ListModel*), UInt32.cast(position))
      GObject::Object.new(__return_value) if __return_value
    end

    def items_changed(position, removed, added)
      __return_value = LibGio.list_model_items_changed((to_unsafe as LibGio::ListModel*), UInt32.cast(position), UInt32.cast(removed), UInt32.cast(added))
      __return_value
    end

module Gio
  class IOStream < GObject::Object
    ...
    def close_async(io_priority, cancellable, callback, user_data)
      __return_value = LibGio.i_o_stream_close_async((to_unsafe as LibGio::IOStream*), Int32.cast(io_priority), cancellable && (cancellable.to_unsafe as LibGio::Cancellable*), callback && callback, user_data)
      __return_value
    end
    ...
    def splice_async(stream2, flags, io_priority, cancellable, callback, user_data)
      __return_value = LibGio.i_o_stream_splice_async((to_unsafe as LibGio::IOStream*), (stream2.to_unsafe as LibGio::IOStream*), flags, Int32.cast(io_priority), cancellable && (cancellable.to_unsafe as LibGio::Cancellable*), callback && callback, user_data)
      __return_value
    end

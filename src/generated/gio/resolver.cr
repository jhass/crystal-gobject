module Gio
  class Resolver < GObject::Object
    ...
    def lookup_by_address_async(address, cancellable, callback, user_data)
      __return_value = LibGio.resolver_lookup_by_address_async(to_unsafe.as(LibGio::Resolver*), address.to_unsafe.as(LibGio::InetAddress*), cancellable ? cancellable.to_unsafe.as(LibGio::Cancellable*) : nil, callback ? callback : nil, user_data ? user_data : nil)
      __return_value
    end
    ...
    def lookup_by_name_async(hostname, cancellable, callback, user_data)
      __return_value = LibGio.resolver_lookup_by_name_async(to_unsafe.as(LibGio::Resolver*), hostname.to_unsafe, cancellable ? cancellable.to_unsafe.as(LibGio::Cancellable*) : nil, callback ? callback : nil, user_data ? user_data : nil)
      __return_value
    end
    ...
    def lookup_records_async(rrname, record_type : Gio::ResolverRecordType, cancellable, callback, user_data)
      __return_value = LibGio.resolver_lookup_records_async(to_unsafe.as(LibGio::Resolver*), rrname.to_unsafe, record_type, cancellable ? cancellable.to_unsafe.as(LibGio::Cancellable*) : nil, callback ? callback : nil, user_data ? user_data : nil)
      __return_value
    end
    ...
    def lookup_service_async(service, protocol, domain, cancellable, callback, user_data)
      __return_value = LibGio.resolver_lookup_service_async(to_unsafe.as(LibGio::Resolver*), service.to_unsafe, protocol.to_unsafe, domain.to_unsafe, cancellable ? cancellable.to_unsafe.as(LibGio::Cancellable*) : nil, callback ? callback : nil, user_data ? user_data : nil)
      __return_value
    end

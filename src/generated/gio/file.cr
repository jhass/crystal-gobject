module Gio
  module File
    ...
    def replace(etag, make_backup, flags : Gio::FileCreateFlags, cancellable)
      __error = Pointer(LibGLib::Error).null
      __return_value = LibGio.file_replace(to_unsafe.as(LibGio::File*), etag, make_backup, flags, cancellable && cancellable.to_unsafe.as(LibGio::Cancellable*), pointerof(__error))
      GLib::Error.assert __error
      Gio::FileOutputStream.new(__return_value)
    end

    def replace_async(etag, make_backup, flags : Gio::FileCreateFlags, io_priority, cancellable, callback, user_data)
      __return_value = LibGio.file_replace_async(to_unsafe.as(LibGio::File*), etag, make_backup, flags, Int32.new(io_priority), cancellable && cancellable.to_unsafe.as(LibGio::Cancellable*), callback && callback, user_data && user_data)
      __return_value
    end

    def replace_contents(contents, length, etag, make_backup, flags : Gio::FileCreateFlags, new_etag, cancellable)
      __error = Pointer(LibGLib::Error).null
      __return_value = LibGio.file_replace_contents(to_unsafe.as(LibGio::File*), contents, UInt64.new(length), etag, make_backup, flags, new_etag, cancellable && cancellable.to_unsafe.as(LibGio::Cancellable*), pointerof(__error))
      GLib::Error.assert __error
      __return_value
    end

    def replace_contents_async(contents, length, etag, make_backup, flags : Gio::FileCreateFlags, cancellable, callback, user_data)
      __return_value = LibGio.file_replace_contents_async(to_unsafe.as(LibGio::File*), contents, UInt64.new(length), etag, make_backup, flags, cancellable && cancellable.to_unsafe.as(LibGio::Cancellable*), callback && callback, user_data && user_data)
      __return_value
    end

    def replace_contents_bytes_async(contents, etag, make_backup, flags : Gio::FileCreateFlags, cancellable, callback, user_data)
      __return_value = LibGio.file_replace_contents_bytes_async(to_unsafe.as(LibGio::File*), contents.to_unsafe.as(LibGLib::Bytes*), etag, make_backup, flags, cancellable && cancellable.to_unsafe.as(LibGio::Cancellable*), callback && callback, user_data && user_data)
      __return_value
    end
    ...
    def replace_readwrite(etag, make_backup, flags : Gio::FileCreateFlags, cancellable)
      __error = Pointer(LibGLib::Error).null
      __return_value = LibGio.file_replace_readwrite(to_unsafe.as(LibGio::File*), etag, make_backup, flags, cancellable && cancellable.to_unsafe.as(LibGio::Cancellable*), pointerof(__error))
      GLib::Error.assert __error
      Gio::FileIOStream.new(__return_value)
    end

    def replace_readwrite_async(etag, make_backup, flags : Gio::FileCreateFlags, io_priority, cancellable, callback, user_data)
      __return_value = LibGio.file_replace_readwrite_async(to_unsafe.as(LibGio::File*), etag, make_backup, flags, Int32.new(io_priority), cancellable && cancellable.to_unsafe.as(LibGio::Cancellable*), callback && callback, user_data && user_data)
      __return_value
    end

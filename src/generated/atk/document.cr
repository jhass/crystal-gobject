module Atk
  module Document
    def attribute_value(attribute_name)
      __return_value = LibAtk.document_get_attribute_value(@pointer.as(LibAtk::Document*), attribute_name.to_unsafe)
      (raise "Expected string but got null" unless __return_value; ::String.new(__return_value)) if __return_value
    end

    def attributes
      __return_value = LibAtk.document_get_attributes(@pointer.as(LibAtk::Document*))
      GLib::SListIterator(Void*, Void**).new(GLib::SList.new(__return_value.as(LibGLib::SList*)))
    end

    def current_page_number
      __return_value = LibAtk.document_get_current_page_number(@pointer.as(LibAtk::Document*))
      __return_value
    end
    ...
    def document_type
      __return_value = LibAtk.document_get_document_type(@pointer.as(LibAtk::Document*))
      (raise "Expected string but got null" unless __return_value; ::String.new(__return_value))
    end

    def locale
      __return_value = LibAtk.document_get_locale(@pointer.as(LibAtk::Document*))
      (raise "Expected string but got null" unless __return_value; ::String.new(__return_value))
    end

    def page_count
      __return_value = LibAtk.document_get_page_count(@pointer.as(LibAtk::Document*))
      __return_value
    end

    def set_attribute_value(attribute_name, attribute_value)
      __return_value = LibAtk.document_set_attribute_value(@pointer.as(LibAtk::Document*), attribute_name.to_unsafe, attribute_value.to_unsafe)
      __return_value
    end

module Atk
  module Table
    def add_column_selection(column)
      __return_value = LibAtk.table_add_column_selection((to_unsafe as LibAtk::Table*), Int32.cast(column))
      __return_value
    end

    def add_row_selection(row)
      __return_value = LibAtk.table_add_row_selection((to_unsafe as LibAtk::Table*), Int32.cast(row))
      __return_value
    end
    ...
    def column_at_index(index)
      __return_value = LibAtk.table_get_column_at_index((to_unsafe as LibAtk::Table*), Int32.cast(index))
      __return_value
    end

    def column_description(column)
      __return_value = LibAtk.table_get_column_description((to_unsafe as LibAtk::Table*), Int32.cast(column))
      raise "Expected string but got null" unless __return_value; String.new(__return_value)
    end

    def column_extent_at(row, column)
      __return_value = LibAtk.table_get_column_extent_at((to_unsafe as LibAtk::Table*), Int32.cast(row), Int32.cast(column))
      __return_value
    end

    def column_header(column)
      __return_value = LibAtk.table_get_column_header((to_unsafe as LibAtk::Table*), Int32.cast(column))
      Atk::Object.new(__return_value) if __return_value
    end

    def index_at(row, column)
      __return_value = LibAtk.table_get_index_at((to_unsafe as LibAtk::Table*), Int32.cast(row), Int32.cast(column))
      __return_value
    end
    ...
    def row_at_index(index)
      __return_value = LibAtk.table_get_row_at_index((to_unsafe as LibAtk::Table*), Int32.cast(index))
      __return_value
    end

    def row_description(row)
      __return_value = LibAtk.table_get_row_description((to_unsafe as LibAtk::Table*), Int32.cast(row))
      raise "Expected string but got null" unless __return_value; String.new(__return_value) if __return_value
    end

    def row_extent_at(row, column)
      __return_value = LibAtk.table_get_row_extent_at((to_unsafe as LibAtk::Table*), Int32.cast(row), Int32.cast(column))
      __return_value
    end

    def row_header(row)
      __return_value = LibAtk.table_get_row_header((to_unsafe as LibAtk::Table*), Int32.cast(row))
      Atk::Object.new(__return_value) if __return_value
    end
    ...
    def is_column_selected(column)
      __return_value = LibAtk.table_is_column_selected((to_unsafe as LibAtk::Table*), Int32.cast(column))
      __return_value
    end

    def is_row_selected(row)
      __return_value = LibAtk.table_is_row_selected((to_unsafe as LibAtk::Table*), Int32.cast(row))
      __return_value
    end

    def is_selected(row, column)
      __return_value = LibAtk.table_is_selected((to_unsafe as LibAtk::Table*), Int32.cast(row), Int32.cast(column))
      __return_value
    end

    def ref_at(row, column)
      __return_value = LibAtk.table_ref_at((to_unsafe as LibAtk::Table*), Int32.cast(row), Int32.cast(column))
      Atk::Object.new(__return_value)
    end

    def remove_column_selection(column)
      __return_value = LibAtk.table_remove_column_selection((to_unsafe as LibAtk::Table*), Int32.cast(column))
      __return_value
    end

    def remove_row_selection(row)
      __return_value = LibAtk.table_remove_row_selection((to_unsafe as LibAtk::Table*), Int32.cast(row))
      __return_value
    end

module GdkPixbuf
  class PixbufLoader < GObject::Object
    @gdk_pixbuf_pixbuf_loader : LibGdkPixbuf::PixbufLoader*?
    def initialize(@gdk_pixbuf_pixbuf_loader : LibGdkPixbuf::PixbufLoader*)
    end

    def to_unsafe
      @gdk_pixbuf_pixbuf_loader.not_nil!.as(Void*)
    end

module Gtk
  class CellRenderer < GObject::InitiallyUnowned
    ...
    def aligned_area(widget, flags : Gtk::CellRendererState, cell_area, aligned_area)
      LibGtk.cell_renderer_get_aligned_area(to_unsafe.as(LibGtk::CellRenderer*), widget.to_unsafe.as(LibGtk::Widget*), flags, cell_area.to_unsafe.as(LibGdk::Rectangle*), aligned_area)
      nil
    end

    def alignment(xalign, yalign)
      LibGtk.cell_renderer_get_alignment(to_unsafe.as(LibGtk::CellRenderer*), xalign, yalign)
      nil
    end

    def fixed_size(width, height)
      LibGtk.cell_renderer_get_fixed_size(to_unsafe.as(LibGtk::CellRenderer*), width, height)
      nil
    end

    def padding(xpad, ypad)
      LibGtk.cell_renderer_get_padding(to_unsafe.as(LibGtk::CellRenderer*), xpad, ypad)
      nil
    end

    def preferred_height(widget, minimum_size, natural_size)
      LibGtk.cell_renderer_get_preferred_height(to_unsafe.as(LibGtk::CellRenderer*), widget.to_unsafe.as(LibGtk::Widget*), minimum_size, natural_size)
      nil
    end

    def preferred_height_for_width(widget, width, minimum_height, natural_height)
      LibGtk.cell_renderer_get_preferred_height_for_width(to_unsafe.as(LibGtk::CellRenderer*), widget.to_unsafe.as(LibGtk::Widget*), Int32.new(width), minimum_height, natural_height)
      nil
    end

    def preferred_size(widget, minimum_size, natural_size)
      LibGtk.cell_renderer_get_preferred_size(to_unsafe.as(LibGtk::CellRenderer*), widget.to_unsafe.as(LibGtk::Widget*), minimum_size, natural_size)
      nil
    end

    def preferred_width(widget, minimum_size, natural_size)
      LibGtk.cell_renderer_get_preferred_width(to_unsafe.as(LibGtk::CellRenderer*), widget.to_unsafe.as(LibGtk::Widget*), minimum_size, natural_size)
      nil
    end

    def preferred_width_for_height(widget, height, minimum_width, natural_width)
      LibGtk.cell_renderer_get_preferred_width_for_height(to_unsafe.as(LibGtk::CellRenderer*), widget.to_unsafe.as(LibGtk::Widget*), Int32.new(height), minimum_width, natural_width)
      nil
    end
    ...
    def size(widget, cell_area, x_offset, y_offset, width, height)
      LibGtk.cell_renderer_get_size(to_unsafe.as(LibGtk::CellRenderer*), widget.to_unsafe.as(LibGtk::Widget*), cell_area ? cell_area.to_unsafe.as(LibGdk::Rectangle*) : nil, x_offset, y_offset, width, height)
      nil
    end
    ...
    def render(cr, widget, background_area, cell_area, flags : Gtk::CellRendererState)
      LibGtk.cell_renderer_render(to_unsafe.as(LibGtk::CellRenderer*), cr.to_unsafe.as(LibCairo::Context*), widget.to_unsafe.as(LibGtk::Widget*), background_area.to_unsafe.as(LibGdk::Rectangle*), cell_area.to_unsafe.as(LibGdk::Rectangle*), flags)
      nil
    end

    def set_alignment(xalign, yalign)
      LibGtk.cell_renderer_set_alignment(to_unsafe.as(LibGtk::CellRenderer*), Float32.new(xalign), Float32.new(yalign))
      nil
    end

    def set_fixed_size(width, height)
      LibGtk.cell_renderer_set_fixed_size(to_unsafe.as(LibGtk::CellRenderer*), Int32.new(width), Int32.new(height))
      nil
    end

    def set_padding(xpad, ypad)
      LibGtk.cell_renderer_set_padding(to_unsafe.as(LibGtk::CellRenderer*), Int32.new(xpad), Int32.new(ypad))
      nil
    end

    def sensitive=(sensitive)
      LibGtk.cell_renderer_set_sensitive(to_unsafe.as(LibGtk::CellRenderer*), sensitive)
      nil
    end

    def visible=(visible)
      LibGtk.cell_renderer_set_visible(to_unsafe.as(LibGtk::CellRenderer*), visible)
      nil
    end
    ...
    def stop_editing(canceled)
      LibGtk.cell_renderer_stop_editing(to_unsafe.as(LibGtk::CellRenderer*), canceled)
      nil
    end

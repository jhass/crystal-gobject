...
module Gtk
  class Gesture < EventController
    ...
    def window=(__value)
      LibGtk.gesture_set_window((to_unsafe as LibGtk::Gesture*), __value)
    end
    ...
    def point(sequence, x, y)
      __return_value = LibGtk.gesture_get_point((to_unsafe as LibGtk::Gesture*), (sequence.to_unsafe as LibGdk::EventSequence*), Float64.cast(x), Float64.cast(y))
      __return_value
    end
    ...
    def sequence_state=(sequence, state)
    ...
    def window=(window)
      __return_value = LibGtk.gesture_set_window((to_unsafe as LibGtk::Gesture*), (window.to_unsafe as LibGdk::Window*))
      __return_value
    end

...
module Gtk
  class GLArea < Widget
    ...
    def required_version(major, minor)
      __return_value = LibGtk.g_l_area_get_required_version((to_unsafe as LibGtk::GLArea*), Int32.cast(major), Int32.cast(minor))
      __return_value
    end
    ...
    def auto_render=(auto_render)
      __return_value = LibGtk.g_l_area_set_auto_render((to_unsafe as LibGtk::GLArea*), Bool.cast(auto_render))
      __return_value
    end
    ...
    def has_alpha=(has_alpha)
      __return_value = LibGtk.g_l_area_set_has_alpha((to_unsafe as LibGtk::GLArea*), Bool.cast(has_alpha))
      __return_value
    end

    def has_depth_buffer=(has_depth_buffer)
      __return_value = LibGtk.g_l_area_set_has_depth_buffer((to_unsafe as LibGtk::GLArea*), Bool.cast(has_depth_buffer))
      __return_value
    end

    def has_stencil_buffer=(has_stencil_buffer)
      __return_value = LibGtk.g_l_area_set_has_stencil_buffer((to_unsafe as LibGtk::GLArea*), Bool.cast(has_stencil_buffer))
      __return_value
    end

    def set_required_version(major, minor)
      __return_value = LibGtk.g_l_area_set_required_version((to_unsafe as LibGtk::GLArea*), Int32.cast(major), Int32.cast(minor))
      __return_value
    end

module Gtk
  class Application < Gio::Application
    ...
    def app_menu=(__value)
      LibGtk.application_set_app_menu((to_unsafe as LibGtk::Application*), __value)
    end

    def menubar=(__value)
      LibGtk.application_set_menubar((to_unsafe as LibGtk::Application*), __value)
    end

    def register_session=(__value)
      LibGtk.application_set_register_session((to_unsafe as LibGtk::Application*), Bool.cast(__value))
    end
    ...
    def add_accelerator(accelerator, action_name, parameter)
      __return_value = LibGtk.application_add_accelerator((to_unsafe as LibGtk::Application*), accelerator, action_name, (parameter.to_unsafe as LibGLib::Variant*))
      __return_value
    end
    ...
    def inhibit(window, flags, reason)
      __return_value = LibGtk.application_inhibit((to_unsafe as LibGtk::Application*), (window.to_unsafe as LibGtk::Window*), flags, reason)
      __return_value
    end
    ...
    def remove_accelerator(action_name, parameter)
      __return_value = LibGtk.application_remove_accelerator((to_unsafe as LibGtk::Application*), action_name, (parameter.to_unsafe as LibGLib::Variant*))
      __return_value
    end
    ...
    def accels_for_action=(detailed_action_name, accels)
    ...
    def app_menu=(app_menu)
      __return_value = LibGtk.application_set_app_menu((to_unsafe as LibGtk::Application*), (app_menu.to_unsafe as LibGio::MenuModel*))
      __return_value
    end

    def menubar=(menubar)
      __return_value = LibGtk.application_set_menubar((to_unsafe as LibGtk::Application*), (menubar.to_unsafe as LibGio::MenuModel*))
      __return_value
    end

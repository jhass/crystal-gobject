module Gtk
  class ListStore < GObject::Object
    ...
    def self.new_internal(n_columns, types)
      __return_value = LibGtk.list_store_new(Int32.cast(n_columns), types)
    ...
    def insert(iter, position)
      __return_value = LibGtk.list_store_insert((to_unsafe as LibGtk::ListStore*), iter, Int32.cast(position))
      __return_value
    end
    ...
    def insert_with_valuesv(iter, position, columns, values, n_values)
      __return_value = LibGtk.list_store_insert_with_valuesv((to_unsafe as LibGtk::ListStore*), iter, Int32.cast(position), columns, values, Int32.cast(n_values))
      __return_value
    end
    ...
    def set(iter, columns, values, n_values)
      __return_value = LibGtk.list_store_set((to_unsafe as LibGtk::ListStore*), (iter.to_unsafe as LibGtk::TreeIter*), columns, values, Int32.cast(n_values))
      __return_value
    end

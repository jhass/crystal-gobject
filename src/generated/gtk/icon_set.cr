module Gtk
  class IconSet
    ...
    def sizes(sizes, n_sizes)
      __return_value = LibGtk.icon_set_get_sizes((to_unsafe as LibGtk::IconSet*), sizes, Int32.cast(n_sizes))
      __return_value
    end
    ...
    def render_icon_pixbuf(context, size)
      __return_value = LibGtk.icon_set_render_icon_pixbuf((to_unsafe as LibGtk::IconSet*), (context.to_unsafe as LibGtk::StyleContext*), Int32.cast(size))
      GdkPixbuf::Pixbuf.new(__return_value)
    end

...
module Gtk
  class ImageMenuItem < MenuItem
    ...
    def always_show_image=(always_show)
      __return_value = LibGtk.image_menu_item_set_always_show_image((to_unsafe as LibGtk::ImageMenuItem*), Bool.cast(always_show))
      __return_value
    end
    ...
    def use_stock=(use_stock)
      __return_value = LibGtk.image_menu_item_set_use_stock((to_unsafe as LibGtk::ImageMenuItem*), Bool.cast(use_stock))
      __return_value
    end

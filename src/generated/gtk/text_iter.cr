module Gtk
  class TextIter
    ...
    def backward_find_char(pred, user_data, limit)
      __return_value = LibGtk.text_iter_backward_find_char(to_unsafe.as(LibGtk::TextIter*), pred, user_data ? user_data : nil, limit ? limit.to_unsafe.as(LibGtk::TextIter*) : nil)
      __return_value
    end
    ...
    def backward_search(str, flags : Gtk::TextSearchFlags, match_start, match_end, limit)
      __return_value = LibGtk.text_iter_backward_search(to_unsafe.as(LibGtk::TextIter*), str.to_unsafe, flags, match_start, match_end, limit ? limit.to_unsafe.as(LibGtk::TextIter*) : nil)
      __return_value
    end
    ...
    def backward_to_tag_toggle(tag)
      __return_value = LibGtk.text_iter_backward_to_tag_toggle(to_unsafe.as(LibGtk::TextIter*), tag ? tag.to_unsafe.as(LibGtk::TextTag*) : nil)
      __return_value
    end
    ...
    def begins_tag(tag)
      __return_value = LibGtk.text_iter_begins_tag(to_unsafe.as(LibGtk::TextIter*), tag ? tag.to_unsafe.as(LibGtk::TextTag*) : nil)
      __return_value
    end
    ...
    def ends_tag(tag)
      __return_value = LibGtk.text_iter_ends_tag(to_unsafe.as(LibGtk::TextIter*), tag ? tag.to_unsafe.as(LibGtk::TextTag*) : nil)
      __return_value
    end
    ...
    def forward_find_char(pred, user_data, limit)
      __return_value = LibGtk.text_iter_forward_find_char(to_unsafe.as(LibGtk::TextIter*), pred, user_data ? user_data : nil, limit ? limit.to_unsafe.as(LibGtk::TextIter*) : nil)
      __return_value
    end
    ...
    def forward_search(str, flags : Gtk::TextSearchFlags, match_start, match_end, limit)
      __return_value = LibGtk.text_iter_forward_search(to_unsafe.as(LibGtk::TextIter*), str.to_unsafe, flags, match_start, match_end, limit ? limit.to_unsafe.as(LibGtk::TextIter*) : nil)
      __return_value
    end
    ...
    def forward_to_tag_toggle(tag)
      __return_value = LibGtk.text_iter_forward_to_tag_toggle(to_unsafe.as(LibGtk::TextIter*), tag ? tag.to_unsafe.as(LibGtk::TextTag*) : nil)
      __return_value
    end
    ...
    def starts_tag(tag)
      __return_value = LibGtk.text_iter_starts_tag(to_unsafe.as(LibGtk::TextIter*), tag ? tag.to_unsafe.as(LibGtk::TextTag*) : nil)
      __return_value
    end
    ...
    def toggles_tag(tag)
      __return_value = LibGtk.text_iter_toggles_tag(to_unsafe.as(LibGtk::TextIter*), tag ? tag.to_unsafe.as(LibGtk::TextTag*) : nil)
      __return_value
    end

...
module Gtk
  class ComboBoxText < ComboBox
    ...
    def to_unsafe
      @gtk_combo_box_text.not_nil!.as(Void*)
    end
    ...
    def append(id, text)
      __return_value = LibGtk.combo_box_text_append(to_unsafe.as(LibGtk::ComboBoxText*), id && id.to_unsafe, text.to_unsafe)
      __return_value
    end
    ...
    def insert(position, id, text)
      __return_value = LibGtk.combo_box_text_insert(to_unsafe.as(LibGtk::ComboBoxText*), Int32.new(position), id && id.to_unsafe, text.to_unsafe)
      __return_value
    end
    ...
    def prepend(id, text)
      __return_value = LibGtk.combo_box_text_prepend(to_unsafe.as(LibGtk::ComboBoxText*), id && id.to_unsafe, text.to_unsafe)
      __return_value
    end

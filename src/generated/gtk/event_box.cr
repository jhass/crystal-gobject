...
module Gtk
  class EventBox < Bin
    ...
    def above_child=(above_child)
      LibGtk.event_box_set_above_child(to_unsafe.as(LibGtk::EventBox*), above_child)
      nil
    end

    def visible_window=(visible_window)
      LibGtk.event_box_set_visible_window(to_unsafe.as(LibGtk::EventBox*), visible_window)
      nil
    end

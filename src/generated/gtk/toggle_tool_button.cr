...
module Gtk
  class ToggleToolButton < ToolButton
    ...
    def active=(__value)
      LibGtk.toggle_tool_button_set_active((to_unsafe as LibGtk::ToggleToolButton*), Bool.cast(__value))
    end
    ...
    def active=(is_active)
      __return_value = LibGtk.toggle_tool_button_set_active((to_unsafe as LibGtk::ToggleToolButton*), Bool.cast(is_active))
      __return_value
    end

module Gdk
  class AppLaunchContext < Gio::AppLaunchContext
    ...
    def icon=(icon)
      __return_value = LibGdk.app_launch_context_set_icon(to_unsafe.as(LibGdk::AppLaunchContext*), icon ? icon.to_unsafe.as(LibGio::Icon*) : nil)
      __return_value
    end

    def icon_name=(icon_name)
      __return_value = LibGdk.app_launch_context_set_icon_name(to_unsafe.as(LibGdk::AppLaunchContext*), icon_name ? icon_name.to_unsafe : nil)
      __return_value
    end

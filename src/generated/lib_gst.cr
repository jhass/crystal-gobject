...
lib LibGst
  ...
  PARAM_MUTABLE_READY = 4 # : Int32
  PARAM_USER_SHIFT = 256 # : Int32
  ...
  fun buffer_extract = gst_buffer_extract(this : Buffer*, offset : UInt64, dest : Void*, size : UInt64) : UInt64
  ...
  fun mini_object_unref = gst_mini_object_unref(this : MiniObject*) : Void
  ...
  fun pipeline_get_clock = gst_pipeline_get_clock(this : Pipeline*) : LibGst::Clock*
  ...
  fun pipeline_set_clock = gst_pipeline_set_clock(this : Pipeline*, clock : LibGst::Clock*) : Bool
  ...
  fun debug_level_get_name = gst_debug_level_get_name(level : LibGst::DebugLevel) : UInt8*
  fun debug_log_default = gst_debug_log_default(category : LibGst::DebugCategory*, level : LibGst::DebugLevel, file : UInt8*, function : UInt8*, line : Int32, object : LibGObject::Object*, message : LibGst::DebugMessage*, unused : Void*) : Void
  ...
  fun value_set_double_range = gst_value_set_double_range(value : LibGObject::Value*, start : Float64, end : Float64) : Void
  fun value_set_fraction = gst_value_set_fraction(value : LibGObject::Value*, numerator : Int32, denominator : Int32) : Void
  fun value_set_fraction_range = gst_value_set_fraction_range(value : LibGObject::Value*, start : LibGObject::Value*, end : LibGObject::Value*) : Void
  ...
  fun value_set_int64_range = gst_value_set_int64_range(value : LibGObject::Value*, start : Int64, end : Int64) : Void
  fun value_set_int64_range_step = gst_value_set_int64_range_step(value : LibGObject::Value*, start : Int64, end : Int64, step : Int64) : Void
  fun value_set_int_range = gst_value_set_int_range(value : LibGObject::Value*, start : Int32, end : Int32) : Void
  fun value_set_int_range_step = gst_value_set_int_range_step(value : LibGObject::Value*, start : Int32, end : Int32, step : Int32) : Void
 ...
 type BufferForeachMetaFunc = LibGst::Buffer*, LibGst::Meta*, Void* -> Bool
 type BufferListFunc = LibGst::Buffer*, UInt32, Void* -> Bool
 type BusFunc = LibGst::Bus*, LibGst::Message*, Void* -> Bool
 type BusSyncHandler = LibGst::Bus*, LibGst::Message*, Void* -> LibGst::BusSyncReply
 type ClockCallback = LibGst::Clock*, UInt64, Void*, Void* -> Bool
 type ControlBindingConvert = LibGst::ControlBinding*, Float64, LibGObject::Value* -> Void
 type ControlSourceGetValue = LibGst::ControlSource*, UInt64, Float64* -> Bool
 type ControlSourceGetValueArray = LibGst::ControlSource*, UInt64, UInt64, UInt32, Float64* -> Bool
 type DebugFuncPtr =  -> Void
 type IteratorCopyFunction = LibGst::Iterator*, LibGst::Iterator* -> Void
 type IteratorFoldFunction = LibGObject::Value*, LibGObject::Value*, Void* -> Bool
 type IteratorForeachFunction = LibGObject::Value*, Void* -> Void
 type IteratorFreeFunction = LibGst::Iterator* -> Void
 type IteratorItemFunction = LibGst::Iterator*, LibGObject::Value* -> LibGst::IteratorItem
 type IteratorNextFunction = LibGst::Iterator*, LibGObject::Value* -> LibGst::IteratorResult
 type IteratorResyncFunction = LibGst::Iterator* -> Void
 type LogFunction = LibGst::DebugCategory*, LibGst::DebugLevel, UInt8*, UInt8*, Int32, LibGObject::Object*, LibGst::DebugMessage*, Void* -> Void
 type MemoryCopyFunction = LibGst::Memory*, Int64, Int64 -> LibGst::Memory*
 type MemoryIsSpanFunction = LibGst::Memory*, LibGst::Memory*, UInt64* -> Bool
 type MemoryShareFunction = LibGst::Memory*, Int64, Int64 -> LibGst::Memory*
 type MemoryUnmapFunction = LibGst::Memory* -> Void
 type MetaFreeFunction = LibGst::Meta*, LibGst::Buffer* -> Void
 type MetaInitFunction = LibGst::Meta*, Void*, LibGst::Buffer* -> Bool
 type MetaTransformFunction = LibGst::Buffer*, LibGst::Meta*, LibGst::Buffer*, UInt32, Void* -> Bool
 type MiniObjectDisposeFunction = LibGst::MiniObject* -> Bool
 type MiniObjectFreeFunction = LibGst::MiniObject* -> Void
 type MiniObjectNotify = Void*, LibGst::MiniObject* -> Void
 type PadActivateFunction = LibGst::Pad*, LibGst::Object* -> Bool
 type PadActivateModeFunction = LibGst::Pad*, LibGst::Object*, LibGst::PadMode, Bool -> Bool
 type PadChainFunction = LibGst::Pad*, LibGst::Object*, LibGst::Buffer* -> LibGst::FlowReturn
 type PadChainListFunction = LibGst::Pad*, LibGst::Object*, LibGst::BufferList* -> LibGst::FlowReturn
 type PadEventFunction = LibGst::Pad*, LibGst::Object*, LibGst::Event* -> Bool
 type PadForwardFunction = LibGst::Pad*, Void* -> Bool
 type PadGetRangeFunction = LibGst::Pad*, LibGst::Object*, UInt64, UInt32, LibGst::Buffer* -> LibGst::FlowReturn
 type PadIterIntLinkFunction = LibGst::Pad*, LibGst::Object* -> LibGst::Iterator*
 type PadLinkFunction = LibGst::Pad*, LibGst::Object*, LibGst::Pad* -> LibGst::PadLinkReturn
 type PadProbeCallback = LibGst::Pad*, LibGst::PadProbeInfo*, Void* -> LibGst::PadProbeReturn
 type PadQueryFunction = LibGst::Pad*, LibGst::Object*, LibGst::Query* -> Bool
 type PadStickyEventsForeachFunction = LibGst::Pad*, LibGst::Event*, Void* -> Bool
 type PadUnlinkFunction = LibGst::Pad*, LibGst::Object* -> Void
 type PluginFeatureFilter = LibGst::PluginFeature*, Void* -> Bool
 type PluginFilter = LibGst::Plugin*, Void* -> Bool
 type PluginInitFullFunc = LibGst::Plugin*, Void* -> Bool
 type PluginInitFunc = LibGst::Plugin* -> Bool
 type StructureForeachFunc = UInt32, LibGObject::Value*, Void* -> Bool
 type StructureMapFunc = UInt32, LibGObject::Value*, Void* -> Bool
 type TagForeachFunc = LibGst::TagList*, UInt8*, Void* -> Void
 type TagMergeFunc = LibGObject::Value*, LibGObject::Value* -> Void
 type TaskFunction = Void* -> Void
 type TaskPoolFunction = Void* -> Void
 type TaskThreadFunc = LibGst::Task*, LibGLib::Thread*, Void* -> Void
 type TypeFindFunction = LibGst::TypeFind*, Void* -> Void
 type ValueCompareFunc = LibGObject::Value*, LibGObject::Value* -> Int32
 type ValueDeserializeFunc = LibGObject::Value*, UInt8* -> Bool
 type ValueSerializeFunc = LibGObject::Value* -> UInt8*
end

module GLib
  class Scanner
    ...
    def cur_line
      __return_value = LibGLib.scanner_cur_line(@pointer.as(LibGLib::Scanner*))
      __return_value
    end

    def cur_position
      __return_value = LibGLib.scanner_cur_position(@pointer.as(LibGLib::Scanner*))
      __return_value
    end

    def cur_token
      __return_value = LibGLib.scanner_cur_token(@pointer.as(LibGLib::Scanner*))
      __return_value
    end
    ...
    def eof
      __return_value = LibGLib.scanner_eof(@pointer.as(LibGLib::Scanner*))
      __return_value
    end

    def next_token
      __return_value = LibGLib.scanner_get_next_token(@pointer.as(LibGLib::Scanner*))
      __return_value
    end
    ...
    def peek_next_token
      __return_value = LibGLib.scanner_peek_next_token(@pointer.as(LibGLib::Scanner*))
      __return_value
    end

    def scope_add_symbol(scope_id, symbol, value)
      LibGLib.scanner_scope_add_symbol(@pointer.as(LibGLib::Scanner*), UInt32.new(scope_id), symbol.to_unsafe, value ? value : nil)
      nil
    end
    ...
    def scope=(scope_id)
      __return_value = LibGLib.scanner_set_scope(@pointer.as(LibGLib::Scanner*), UInt32.new(scope_id))
      __return_value
    end

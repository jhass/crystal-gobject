module GLib
  class ScannerConfig
    ...
    def cset_skip_characters
      (raise "Expected string but got null" unless (to_unsafe.as(LibGLib::ScannerConfig*).value.cset_skip_characters); ::String.new((to_unsafe.as(LibGLib::ScannerConfig*).value.cset_skip_characters)))
    end
    ...
    def cset_identifier_first
      (raise "Expected string but got null" unless (to_unsafe.as(LibGLib::ScannerConfig*).value.cset_identifier_first); ::String.new((to_unsafe.as(LibGLib::ScannerConfig*).value.cset_identifier_first)))
    end
    ...
    def cset_identifier_nth
      (raise "Expected string but got null" unless (to_unsafe.as(LibGLib::ScannerConfig*).value.cset_identifier_nth); ::String.new((to_unsafe.as(LibGLib::ScannerConfig*).value.cset_identifier_nth)))
    end
    ...
    def cpair_comment_single
      (raise "Expected string but got null" unless (to_unsafe.as(LibGLib::ScannerConfig*).value.cpair_comment_single); ::String.new((to_unsafe.as(LibGLib::ScannerConfig*).value.cpair_comment_single)))
    end

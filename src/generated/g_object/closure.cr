module GObject
  class Closure
    ...
    def self.new_object(sizeof_closure, object)
      __return_value = LibGObject.closure_new_object(UInt32.cast(sizeof_closure), (object.to_unsafe as LibGObject::Object*))
      GObject::Closure.new(__return_value)
    end

    def self.new_simple(sizeof_closure, data)
      __return_value = LibGObject.closure_new_simple(UInt32.cast(sizeof_closure), data)
      GObject::Closure.new(__return_value)
    end

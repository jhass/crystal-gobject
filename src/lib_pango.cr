...
lib LibPango
  ...
  fun glyph_string_index_to_x = pango_glyph_string_index_to_x(this : GlyphString*, text : UInt8*, length : Int32, analysis : LibPango::Analysis*, index_ : Int32, trailing : Bool, x_pos : Int32*) : Void
  fun glyph_string_set_size = pango_glyph_string_set_size(this : GlyphString*, new_len : Int32) : Void
  fun glyph_string_x_to_index = pango_glyph_string_x_to_index(this : GlyphString*, text : UInt8*, length : Int32, analysis : LibPango::Analysis*, x_pos : Int32, index_ : Int32*, trailing : Int32*) : Void
  ...
  fun layout_line_index_to_x = pango_layout_line_index_to_x(this : LayoutLine*, index_ : Int32, trailing : Bool, x_pos : Int32*) : Void
  ...
  fun layout_line_x_to_index = pango_layout_line_x_to_index(this : LayoutLine*, x_pos : Int32, index_ : Int32*, trailing : Int32*) : Bool
  ...
  # Callback: AttrFilterFunc(attribute : LibPango::Attribute*, user_data : Void*) : Bool
  # Callback: FontsetForeachFunc(fontset : LibPango::Fontset*, font : LibPango::Font*, user_data : Void*) : Bool
  ...
  fun layout_index_to_line_x = pango_layout_index_to_line_x(this : Layout*, index_ : Int32, trailing : Bool, line : Int32*, x_pos : Int32*) : Void
  ...
  fun layout_xy_to_index = pango_layout_xy_to_index(this : Layout*, x : Int32, y : Int32, index_ : Int32*, trailing : Int32*) : Bool
  ...
  fun module_register = pango_module_register(module : LibPango::IncludedModule*) : Void

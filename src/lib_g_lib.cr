...
lib LibGLib
  ...
  struct Array; end; # struct
  struct AsyncQueue; end; # struct
  struct BookmarkFile; end; # struct
  struct ByteArray; end; # struct
  struct Bytes; end; # struct
  struct Checksum; end; # struct
  struct Cond; end; # struct
  struct Data; end; # struct
  struct Date; end; # struct
  struct DateTime; end; # struct
  struct DebugKey; end; # struct
  struct Dir; end; # struct
  struct Error; end; # struct
  struct HashTable; end; # struct
  struct HashTableIter; end; # struct
  struct Hmac; end; # struct
  struct Hook; end; # struct
  struct HookList; end; # struct
  struct IConv; end; # struct
  struct IOChannel; end; # struct
  struct IOFuncs; end; # struct
  struct KeyFile; end; # struct
  struct List; end; # struct
  struct MainContext; end; # struct
  struct MainLoop; end; # struct
  struct MappedFile; end; # struct
  struct MarkupParseContext; end; # struct
  struct MarkupParser; end; # struct
  struct MatchInfo; end; # struct
  struct MemVTable; end; # struct
  struct Node; end; # struct
  struct Once; end; # struct
  struct OptionContext; end; # struct
  struct OptionEntry; end; # struct
  struct OptionGroup; end; # struct
  struct PatternSpec; end; # struct
  struct PollFD; end; # struct
  struct Private; end; # struct
  struct PtrArray; end; # struct
  struct Queue; end; # struct
  struct RWLock; end; # struct
  struct Rand; end; # struct
  struct RecMutex; end; # struct
  struct Regex; end; # struct
  struct SList; end; # struct
  struct Scanner; end; # struct
  struct ScannerConfig; end; # struct
  struct Sequence; end; # struct
  struct SequenceIter; end; # struct
  struct Source; end; # struct
  struct SourceCallbackFuncs; end; # struct
  struct SourceFuncs; end; # struct
  struct SourcePrivate; end; # struct
  struct StatBuf; end; # struct
  struct String; end; # struct
  struct StringChunk; end; # struct
  struct TestCase; end; # struct
  struct TestConfig; end; # struct
  struct TestLogBuffer; end; # struct
  struct TestLogMsg; end; # struct
  struct TestSuite; end; # struct
  struct Thread; end; # struct
  struct ThreadPool; end; # struct
  struct TimeVal; end; # struct
  struct TimeZone; end; # struct
  struct Timer; end; # struct
  struct TrashStack; end; # struct
  struct Tree; end; # struct
  struct Variant; end; # struct
  struct VariantBuilder; end; # struct
  struct VariantDict; end; # struct
  struct VariantType; end; # struct
  union DoubleIEEE754; end
  union FloatIEEE754; end
  union Mutex; end
  union TokenValue; end
  ...
  HAVE___INLINE = 1 # : Int32
  HAVE___INLINE__ = 1 # : Int32
  ...
  fun date_time_difference = g_date_time_difference(this : DateTime*, begin : LibGLib::DateTime*) : Int64
  ...
  fun i_conv_ = g_iconv(this : IConv*, inbuf : UInt8*, inbytes_left : UInt64*, outbuf : UInt8*, outbytes_left : UInt64*) : UInt64
  ...
  fun rand_double_range = g_rand_double_range(this : Rand*, begin : Float64, end : Float64) : Float64
  fun rand_free = g_rand_free(this : Rand*) : Void
  fun rand_int = g_rand_int(this : Rand*) : UInt32
  fun rand_int_range = g_rand_int_range(this : Rand*, begin : Int32, end : Int32) : Int32
  ...
  fun sequence_move_range = g_sequence_move_range(dest : LibGLib::SequenceIter*, begin : LibGLib::SequenceIter*, end : LibGLib::SequenceIter*) : Void
  fun sequence_remove = g_sequence_remove(iter : LibGLib::SequenceIter*) : Void
  fun sequence_remove_range = g_sequence_remove_range(begin : LibGLib::SequenceIter*, end : LibGLib::SequenceIter*) : Void
  ...
  # Callback: ChildWatchFunc(pid : Int32, status : Int32, user_data : Void*) : Void
  # Callback: CompareDataFunc(a : Void*, b : Void*, user_data : Void*) : Int32
  # Callback: CompareFunc(a : Void*, b : Void*) : Int32
  # Callback: DataForeachFunc(key_id : UInt32, data : Void*, user_data : Void*) : Void
  # Callback: DestroyNotify(data : Void*) : Void
  # Callback: EqualFunc(a : Void*, b : Void*) : Bool
  # Callback: FreeFunc(data : Void*) : Void
  # Callback: Func(data : Void*, user_data : Void*) : Void
  # Callback: HFunc(key : Void*, value : Void*, user_data : Void*) : Void
  # Callback: HRFunc(key : Void*, value : Void*, user_data : Void*) : Bool
  # Callback: HashFunc(key : Void*) : UInt32
  # Callback: HookCheckFunc(data : Void*) : Bool
  # Callback: HookCheckMarshaller(hook : LibGLib::Hook*, marshal_data : Void*) : Bool
  # Callback: HookCompareFunc(new_hook : LibGLib::Hook*, sibling : LibGLib::Hook*) : Int32
  # Callback: HookFinalizeFunc(hook_list : LibGLib::HookList*, hook : LibGLib::Hook*) : Void
  # Callback: HookFindFunc(hook : LibGLib::Hook*, data : Void*) : Bool
  # Callback: HookFunc(data : Void*) : Void
  # Callback: HookMarshaller(hook : LibGLib::Hook*, marshal_data : Void*) : Void
  # Callback: IOFunc(source : LibGLib::IOChannel*, condition : LibGLib::IOCondition, data : Void*) : Bool
  # Callback: LogFunc(log_domain : UInt8*, log_level : LibGLib::LogLevelFlags, message : UInt8*, user_data : Void*) : Void
  # Callback: NodeForeachFunc(node : LibGLib::Node*, data : Void*) : Void
  # Callback: NodeTraverseFunc(node : LibGLib::Node*, data : Void*) : Bool
  # Callback: OptionArgFunc(option_name : UInt8*, value : UInt8*, data : Void*) : Bool
  # Callback: OptionErrorFunc(context : LibGLib::OptionContext*, group : LibGLib::OptionGroup*, data : Void*) : Void
  # Callback: OptionParseFunc(context : LibGLib::OptionContext*, group : LibGLib::OptionGroup*, data : Void*) : Bool
  # Callback: PollFunc(ufds : LibGLib::PollFD*, nfsd : UInt32, timeout_ : Int32) : Int32
  # Callback: PrintFunc(string : UInt8*) : Void
  # Callback: RegexEvalCallback(match_info : LibGLib::MatchInfo*, result : LibGLib::String*, user_data : Void*) : Bool
  # Callback: ScannerMsgFunc(scanner : LibGLib::Scanner*, message : UInt8*, error : Bool) : Void
  # Callback: SequenceIterCompareFunc(a : LibGLib::SequenceIter*, b : LibGLib::SequenceIter*, data : Void*) : Int32
  # Callback: SourceDummyMarshal() : Void
  # Callback: SourceFunc(user_data : Void*) : Bool
  # Callback: SpawnChildSetupFunc(user_data : Void*) : Void
  # Callback: TestDataFunc(user_data : Void*) : Void
  # Callback: TestFixtureFunc(fixture : Void*, user_data : Void*) : Void
  # Callback: TestFunc() : Void
  # Callback: TestLogFatalFunc(log_domain : UInt8*, log_level : LibGLib::LogLevelFlags, message : UInt8*, user_data : Void*) : Bool
  # Callback: TranslateFunc(str : UInt8*, data : Void*) : UInt8*
  # Callback: TraverseFunc(key : Void*, value : Void*, data : Void*) : Bool
  # Callback: UnixFDSourceFunc(fd : Int32, condition : LibGLib::IOCondition, user_data : Void*) : Bool
  ...
  fun base64_decode_step = g_base64_decode_step(in : UInt8*, len : UInt64, out : UInt8**, state : Int32, save : UInt32) : UInt64
  fun base64_encode = g_base64_encode(data : UInt8*, len : UInt64) : UInt8*
  fun base64_encode_close = g_base64_encode_close(break_lines : Bool, out : UInt8**, state : Int32, save : Int32) : UInt64
  fun base64_encode_step = g_base64_encode_step(in : UInt8*, len : UInt64, break_lines : Bool, out : UInt8**, state : Int32, save : Int32) : UInt64
  ...
  fun random_double_range = g_random_double_range(begin : Float64, end : Float64) : Float64
  fun random_int = g_random_int() : UInt32
  fun random_int_range = g_random_int_range(begin : Int32, end : Int32) : Int32
  ...
  fun return_if_fail_warning = g_return_if_fail_warning(log_domain : UInt8*, pretty_function : UInt8*, expression : UInt8*) : Void
  ...
  fun test_rand_int_range = g_test_rand_int_range(begin : Int32, end : Int32) : Int32
  ...
  fun variant_type_string_is_valid = g_variant_type_string_is_valid(type_string : UInt8*) : Bool
  fun variant_type_string_scan = g_variant_type_string_scan(string : UInt8*, limit : UInt8*, endptr : UInt8**) : Bool
  fun warn_message = g_warn_message(domain : UInt8*, file : UInt8*, line : Int32, func : UInt8*, warnexpr : UInt8*) : Void
end

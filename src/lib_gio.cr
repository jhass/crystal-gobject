...
lib LibGio
  ...
  struct ActionGroup; end # interface
  struct ActionMap; end # interface
  struct AppInfo; end # interface
  struct AsyncInitable; end # interface
  struct AsyncResult; end # interface
  struct Converter; end # interface
  struct DBusInterface; end # interface
  struct DBusObject; end # interface
  struct DBusObjectManager; end # interface
  struct DesktopAppInfoLookup; end # interface
  struct Drive; end # interface
  struct File; end # interface
  struct FileDescriptorBased; end # interface
  struct Icon; end # interface
  struct Initable; end # interface
  struct LoadableIcon; end # interface
  struct Mount; end # interface
  struct NetworkMonitor; end # interface
  struct PollableInputStream; end # interface
  struct PollableOutputStream; end # interface
  struct Proxy; end # interface
  struct ProxyResolver; end # interface
  struct RemoteActionGroup; end # interface
  struct Seekable; end # interface
  struct SocketConnectable; end # interface
  struct TlsBackend; end # interface
  struct TlsClientConnection; end # interface
  struct TlsFileDatabase; end # interface
  struct TlsServerConnection; end # interface
  struct Volume; end # interface
  struct ActionEntry; end; # struct
  struct AppLaunchContextPrivate; end; # struct
  struct ApplicationCommandLinePrivate; end; # struct
  struct ApplicationPrivate; end; # struct
  struct BufferedInputStreamPrivate; end; # struct
  struct BufferedOutputStreamPrivate; end; # struct
  struct CancellablePrivate; end; # struct
  struct ConverterInputStreamPrivate; end; # struct
  struct ConverterOutputStreamPrivate; end; # struct
  struct DBusAnnotationInfo; end; # struct
  struct DBusArgInfo; end; # struct
  struct DBusErrorEntry; end; # struct
  struct DBusInterfaceInfo; end; # struct
  struct DBusInterfaceSkeletonPrivate; end; # struct
  struct DBusInterfaceVTable; end; # struct
  struct DBusMethodInfo; end; # struct
  struct DBusNodeInfo; end; # struct
  struct DBusObjectManagerClientPrivate; end; # struct
  struct DBusObjectManagerServerPrivate; end; # struct
  struct DBusObjectProxyPrivate; end; # struct
  struct DBusObjectSkeletonPrivate; end; # struct
  struct DBusPropertyInfo; end; # struct
  struct DBusProxyPrivate; end; # struct
  struct DBusSignalInfo; end; # struct
  struct DBusSubtreeVTable; end; # struct
  struct DataInputStreamPrivate; end; # struct
  struct DataOutputStreamPrivate; end; # struct
  struct EmblemedIconPrivate; end; # struct
  struct FileAttributeInfo; end; # struct
  struct FileAttributeInfoList; end; # struct
  struct FileAttributeMatcher; end; # struct
  struct FileEnumeratorPrivate; end; # struct
  struct FileIOStreamPrivate; end; # struct
  struct FileInputStreamPrivate; end; # struct
  struct FileMonitorPrivate; end; # struct
  struct FileOutputStreamPrivate; end; # struct
  struct IOExtension; end; # struct
  struct IOExtensionPoint; end; # struct
  struct IOModuleScope; end; # struct
  struct IOSchedulerJob; end; # struct
  struct IOStreamAdapter; end; # struct
  struct IOStreamPrivate; end; # struct
  struct InetAddressMaskPrivate; end; # struct
  struct InetAddressPrivate; end; # struct
  struct InetSocketAddressPrivate; end; # struct
  struct InputStreamPrivate; end; # struct
  struct InputVector; end; # struct
  struct MemoryInputStreamPrivate; end; # struct
  struct MemoryOutputStreamPrivate; end; # struct
  struct MenuAttributeIterPrivate; end; # struct
  struct MenuLinkIterPrivate; end; # struct
  struct MenuModelPrivate; end; # struct
  struct MountOperationPrivate; end; # struct
  struct NetworkAddressPrivate; end; # struct
  struct NetworkServicePrivate; end; # struct
  struct OutputStreamPrivate; end; # struct
  struct OutputVector; end; # struct
  struct PermissionPrivate; end; # struct
  struct ProxyAddressEnumeratorPrivate; end; # struct
  struct ProxyAddressPrivate; end; # struct
  struct ResolverPrivate; end; # struct
  struct Resource; end; # struct
  struct SettingsBackend; end; # struct
  struct SettingsPrivate; end; # struct
  struct SettingsSchema; end; # struct
  struct SettingsSchemaKey; end; # struct
  struct SettingsSchemaSource; end; # struct
  struct SimpleActionGroupPrivate; end; # struct
  struct SimpleProxyResolverPrivate; end; # struct
  struct SocketClientPrivate; end; # struct
  struct SocketConnectionPrivate; end; # struct
  struct SocketControlMessagePrivate; end; # struct
  struct SocketListenerPrivate; end; # struct
  struct SocketPrivate; end; # struct
  struct SocketServicePrivate; end; # struct
  struct SrvTarget; end; # struct
  struct StaticResource; end; # struct
  struct TcpConnectionPrivate; end; # struct
  struct TcpWrapperConnectionPrivate; end; # struct
  struct ThreadedSocketServicePrivate; end; # struct
  struct TlsCertificatePrivate; end; # struct
  struct TlsConnectionPrivate; end; # struct
  struct TlsDatabasePrivate; end; # struct
  struct TlsInteractionPrivate; end; # struct
  struct TlsPasswordPrivate; end; # struct
  struct UnixConnectionPrivate; end; # struct
  struct UnixCredentialsMessagePrivate; end; # struct
  struct UnixFDListPrivate; end; # struct
  struct UnixFDMessagePrivate; end; # struct
  struct UnixInputStreamPrivate; end; # struct
  struct UnixMountEntry; end; # struct
  struct UnixMountPoint; end; # struct
  struct UnixOutputStreamPrivate; end; # struct
  struct UnixSocketAddressPrivate; end; # struct
  struct AppInfoMonitor; end # object
  struct AppLaunchContext; end # object
  struct Application; end # object
  struct ApplicationCommandLine; end # object
  struct BufferedInputStream; end # object
  struct BufferedOutputStream; end # object
  struct BytesIcon; end # object
  struct Cancellable; end # object
  struct CharsetConverter; end # object
  struct ConverterInputStream; end # object
  struct ConverterOutputStream; end # object
  struct Credentials; end # object
  struct DBusActionGroup; end # object
  struct DBusAuthObserver; end # object
  struct DBusConnection; end # object
  struct DBusInterfaceSkeleton; end # object
  struct DBusMenuModel; end # object
  struct DBusMessage; end # object
  struct DBusMethodInvocation; end # object
  struct DBusObjectManagerClient; end # object
  struct DBusObjectManagerServer; end # object
  struct DBusObjectProxy; end # object
  struct DBusObjectSkeleton; end # object
  struct DBusProxy; end # object
  struct DBusServer; end # object
  struct DataInputStream; end # object
  struct DataOutputStream; end # object
  struct DesktopAppInfo; end # object
  struct Emblem; end # object
  struct EmblemedIcon; end # object
  struct FileEnumerator; end # object
  struct FileIOStream; end # object
  struct FileIcon; end # object
  struct FileInfo; end # object
  struct FileInputStream; end # object
  struct FileMonitor; end # object
  struct FileOutputStream; end # object
  struct FilenameCompleter; end # object
  struct FilterInputStream; end # object
  struct FilterOutputStream; end # object
  struct IOModule; end # object
  struct IOStream; end # object
  struct InetAddress; end # object
  struct InetAddressMask; end # object
  struct InetSocketAddress; end # object
  struct InputStream; end # object
  struct MemoryInputStream; end # object
  struct MemoryOutputStream; end # object
  struct Menu; end # object
  struct MenuAttributeIter; end # object
  struct MenuItem; end # object
  struct MenuLinkIter; end # object
  struct MenuModel; end # object
  struct MountOperation; end # object
  struct NativeVolumeMonitor; end # object
  struct NetworkAddress; end # object
  struct NetworkService; end # object
  struct Notification; end # object
  struct OutputStream; end # object
  struct Permission; end # object
  struct PropertyAction; end # object
  struct ProxyAddress; end # object
  struct ProxyAddressEnumerator; end # object
  struct Resolver; end # object
  struct Settings; end # object
  struct SimpleAction; end # object
  struct SimpleActionGroup; end # object
  struct SimpleAsyncResult; end # object
  struct SimplePermission; end # object
  struct SimpleProxyResolver; end # object
  struct Socket; end # object
  struct SocketAddress; end # object
  struct SocketAddressEnumerator; end # object
  struct SocketClient; end # object
  struct SocketConnection; end # object
  struct SocketControlMessage; end # object
  struct SocketListener; end # object
  struct SocketService; end # object
  struct Subprocess; end # object
  struct SubprocessLauncher; end # object
  struct Task; end # object
  struct TcpConnection; end # object
  struct TcpWrapperConnection; end # object
  struct TestDBus; end # object
  struct ThemedIcon; end # object
  struct ThreadedSocketService; end # object
  struct TlsCertificate; end # object
  struct TlsConnection; end # object
  struct TlsDatabase; end # object
  struct TlsInteraction; end # object
  struct TlsPassword; end # object
  struct UnixConnection; end # object
  struct UnixCredentialsMessage; end # object
  struct UnixFDList; end # object
  struct UnixFDMessage; end # object
  struct UnixInputStream; end # object
  struct UnixMountMonitor; end # object
  struct UnixOutputStream; end # object
  struct UnixSocketAddress; end # object
  struct Vfs; end # object
  struct VolumeMonitor; end # object
  struct ZlibCompressor; end # object
  struct ZlibDecompressor; end # object
  ...
  fun async_initable_newv_async = g_async_initable_newv_async(object_type : UInt64, n_parameters : UInt32, parameters : LibGObject::Parameter*, io_priority : Int32, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  fun async_initable_init_async = g_async_initable_init_async(this : AsyncInitable*, io_priority : Int32, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun converter_convert = g_converter_convert(this : Converter*, inbuf : UInt8*, inbuf_size : UInt64, outbuf : Void*, outbuf_size : UInt64, flags : LibGio::ConverterFlags, bytes_read : UInt64*, bytes_written : UInt64*, error : LibGLib::Error**) : LibGio::ConverterResult
  ...
  fun drive_eject = g_drive_eject(this : Drive*, flags : LibGio::MountUnmountFlags, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  fun drive_eject_finish = g_drive_eject_finish(this : Drive*, result : LibGio::AsyncResult*, error : LibGLib::Error**) : Bool
  fun drive_eject_with_operation = g_drive_eject_with_operation(this : Drive*, flags : LibGio::MountUnmountFlags, mount_operation : LibGio::MountOperation*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun drive_poll_for_media = g_drive_poll_for_media(this : Drive*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun drive_start = g_drive_start(this : Drive*, flags : LibGio::DriveStartFlags, mount_operation : LibGio::MountOperation*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  fun drive_start_finish = g_drive_start_finish(this : Drive*, result : LibGio::AsyncResult*, error : LibGLib::Error**) : Bool
  fun drive_stop = g_drive_stop(this : Drive*, flags : LibGio::MountUnmountFlags, mount_operation : LibGio::MountOperation*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun file_append_to_async = g_file_append_to_async(this : File*, flags : LibGio::FileCreateFlags, io_priority : Int32, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun file_copy = g_file_copy(this : File*, destination : LibGio::File*, flags : LibGio::FileCopyFlags, cancellable : LibGio::Cancellable*, progress_callback : Void*, progress_callback_data : Void*, error : LibGLib::Error**) : Bool
  ...
  fun file_create_async = g_file_create_async(this : File*, flags : LibGio::FileCreateFlags, io_priority : Int32, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun file_create_readwrite_async = g_file_create_readwrite_async(this : File*, flags : LibGio::FileCreateFlags, io_priority : Int32, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun file_delete_async = g_file_delete_async(this : File*, io_priority : Int32, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun file_eject_mountable = g_file_eject_mountable(this : File*, flags : LibGio::MountUnmountFlags, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun file_eject_mountable_with_operation = g_file_eject_mountable_with_operation(this : File*, flags : LibGio::MountUnmountFlags, mount_operation : LibGio::MountOperation*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun file_enumerate_children_async = g_file_enumerate_children_async(this : File*, attributes : UInt8*, flags : LibGio::FileQueryInfoFlags, io_priority : Int32, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun file_find_enclosing_mount_async = g_file_find_enclosing_mount_async(this : File*, io_priority : Int32, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun file_load_contents_async = g_file_load_contents_async(this : File*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun file_make_directory_async = g_file_make_directory_async(this : File*, io_priority : Int32, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun file_mount_enclosing_volume = g_file_mount_enclosing_volume(this : File*, flags : LibGio::MountMountFlags, mount_operation : LibGio::MountOperation*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun file_mount_mountable = g_file_mount_mountable(this : File*, flags : LibGio::MountMountFlags, mount_operation : LibGio::MountOperation*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun file_move = g_file_move(this : File*, destination : LibGio::File*, flags : LibGio::FileCopyFlags, cancellable : LibGio::Cancellable*, progress_callback : Void*, progress_callback_data : Void*, error : LibGLib::Error**) : Bool
  ...
  fun file_open_readwrite_async = g_file_open_readwrite_async(this : File*, io_priority : Int32, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun file_poll_mountable = g_file_poll_mountable(this : File*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun file_query_filesystem_info_async = g_file_query_filesystem_info_async(this : File*, attributes : UInt8*, io_priority : Int32, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun file_query_info_async = g_file_query_info_async(this : File*, attributes : UInt8*, flags : LibGio::FileQueryInfoFlags, io_priority : Int32, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun file_read_async = g_file_read_async(this : File*, io_priority : Int32, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun file_replace_async = g_file_replace_async(this : File*, etag : UInt8*, make_backup : Bool, flags : LibGio::FileCreateFlags, io_priority : Int32, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun file_replace_contents_async = g_file_replace_contents_async(this : File*, contents : UInt8*, length : UInt64, etag : UInt8*, make_backup : Bool, flags : LibGio::FileCreateFlags, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  fun file_replace_contents_bytes_async = g_file_replace_contents_bytes_async(this : File*, contents : LibGLib::Bytes*, etag : UInt8*, make_backup : Bool, flags : LibGio::FileCreateFlags, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun file_replace_readwrite_async = g_file_replace_readwrite_async(this : File*, etag : UInt8*, make_backup : Bool, flags : LibGio::FileCreateFlags, io_priority : Int32, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun file_set_attributes_async = g_file_set_attributes_async(this : File*, info : LibGio::FileInfo*, flags : LibGio::FileQueryInfoFlags, io_priority : Int32, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun file_set_display_name_async = g_file_set_display_name_async(this : File*, display_name : UInt8*, io_priority : Int32, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun file_start_mountable = g_file_start_mountable(this : File*, flags : LibGio::DriveStartFlags, start_operation : LibGio::MountOperation*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun file_stop_mountable = g_file_stop_mountable(this : File*, flags : LibGio::MountUnmountFlags, mount_operation : LibGio::MountOperation*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun file_trash_async = g_file_trash_async(this : File*, io_priority : Int32, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  fun file_trash_finish = g_file_trash_finish(this : File*, result : LibGio::AsyncResult*, error : LibGLib::Error**) : Bool
  fun file_unmount_mountable = g_file_unmount_mountable(this : File*, flags : LibGio::MountUnmountFlags, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun file_unmount_mountable_with_operation = g_file_unmount_mountable_with_operation(this : File*, flags : LibGio::MountUnmountFlags, mount_operation : LibGio::MountOperation*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun loadable_icon_load_async = g_loadable_icon_load_async(this : LoadableIcon*, size : Int32, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun mount_eject = g_mount_eject(this : Mount*, flags : LibGio::MountUnmountFlags, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  fun mount_eject_finish = g_mount_eject_finish(this : Mount*, result : LibGio::AsyncResult*, error : LibGLib::Error**) : Bool
  fun mount_eject_with_operation = g_mount_eject_with_operation(this : Mount*, flags : LibGio::MountUnmountFlags, mount_operation : LibGio::MountOperation*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun mount_guess_content_type = g_mount_guess_content_type(this : Mount*, force_rescan : Bool, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun mount_remount = g_mount_remount(this : Mount*, flags : LibGio::MountMountFlags, mount_operation : LibGio::MountOperation*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun mount_unmount = g_mount_unmount(this : Mount*, flags : LibGio::MountUnmountFlags, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  fun mount_unmount_finish = g_mount_unmount_finish(this : Mount*, result : LibGio::AsyncResult*, error : LibGLib::Error**) : Bool
  fun mount_unmount_with_operation = g_mount_unmount_with_operation(this : Mount*, flags : LibGio::MountUnmountFlags, mount_operation : LibGio::MountOperation*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun network_monitor_can_reach_async = g_network_monitor_can_reach_async(this : NetworkMonitor*, connectable : LibGio::SocketConnectable*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun proxy_connect_async = g_proxy_connect_async(this : Proxy*, connection : LibGio::IOStream*, proxy_address : LibGio::ProxyAddress*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun proxy_resolver_lookup_async = g_proxy_resolver_lookup_async(this : ProxyResolver*, uri : UInt8*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun volume_eject = g_volume_eject(this : Volume*, flags : LibGio::MountUnmountFlags, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  fun volume_eject_finish = g_volume_eject_finish(this : Volume*, result : LibGio::AsyncResult*, error : LibGLib::Error**) : Bool
  fun volume_eject_with_operation = g_volume_eject_with_operation(this : Volume*, flags : LibGio::MountUnmountFlags, mount_operation : LibGio::MountOperation*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun volume_mount = g_volume_mount(this : Volume*, flags : LibGio::MountMountFlags, mount_operation : LibGio::MountOperation*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun i_o_scheduler_job_send_to_mainloop = g_io_scheduler_job_send_to_mainloop(this : IOSchedulerJob*, func : Void*, user_data : Void*, notify : Void*) : Bool
  fun i_o_scheduler_job_send_to_mainloop_async = g_io_scheduler_job_send_to_mainloop_async(this : IOSchedulerJob*, func : Void*, user_data : Void*, notify : Void*) : Void
  ...
  # Implements ActionMap
    ...
    # Property application-id : UInt8*
    # Property flags : LibGio::ApplicationFlags
    # Property inactivity-timeout : UInt32
    # Property is-registered : Bool
    # Property is-remote : Bool
    # Property resource-base-path : UInt8*
    # Signal activate
    # Signal command-line
  ...
  fun buffered_input_stream_fill_async = g_buffered_input_stream_fill_async(this : BufferedInputStream*, count : Int64, io_priority : Int32, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun cancellable_connect = g_cancellable_connect(this : Cancellable*, callback : Void*, data : Void*, data_destroy_func : Void*) : UInt64
  ...
  # Implements Initable
    # Property from-charset : UInt8*
    # Property to-charset : UInt8*
    # Property use-fallback : Bool
  end
  ...
  fun d_bus_connection_new = g_dbus_connection_new(stream : LibGio::IOStream*, guid : UInt8*, flags : LibGio::DBusConnectionFlags, observer : LibGio::DBusAuthObserver*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  fun d_bus_connection_new_for_address = g_dbus_connection_new_for_address(address : UInt8*, flags : LibGio::DBusConnectionFlags, observer : LibGio::DBusAuthObserver*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  fun d_bus_connection_add_filter = g_dbus_connection_add_filter(this : DBusConnection*, filter_function : Void*, user_data : Void*, user_data_free_func : Void*) : UInt32
  fun d_bus_connection_call = g_dbus_connection_call(this : DBusConnection*, bus_name : UInt8*, object_path : UInt8*, interface_name : UInt8*, method_name : UInt8*, parameters : LibGLib::Variant*, reply_type : LibGLib::VariantType*, flags : LibGio::DBusCallFlags, timeout_msec : Int32, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun d_bus_connection_call_with_unix_fd_list = g_dbus_connection_call_with_unix_fd_list(this : DBusConnection*, bus_name : UInt8*, object_path : UInt8*, interface_name : UInt8*, method_name : UInt8*, parameters : LibGLib::Variant*, reply_type : LibGLib::VariantType*, flags : LibGio::DBusCallFlags, timeout_msec : Int32, fd_list : LibGio::UnixFDList*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun d_bus_connection_close = g_dbus_connection_close(this : DBusConnection*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun d_bus_connection_flush = g_dbus_connection_flush(this : DBusConnection*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun d_bus_connection_register_object = g_dbus_connection_register_object(this : DBusConnection*, object_path : UInt8*, interface_info : LibGio::DBusInterfaceInfo*, vtable : LibGio::DBusInterfaceVTable*, user_data : Void*, user_data_free_func : Void*, error : LibGLib::Error**) : UInt32
  fun d_bus_connection_register_subtree = g_dbus_connection_register_subtree(this : DBusConnection*, object_path : UInt8*, vtable : LibGio::DBusSubtreeVTable*, flags : LibGio::DBusSubtreeFlags, user_data : Void*, user_data_free_func : Void*, error : LibGLib::Error**) : UInt32
  ...
  fun d_bus_connection_send_message_with_reply = g_dbus_connection_send_message_with_reply(this : DBusConnection*, message : LibGio::DBusMessage*, flags : LibGio::DBusSendMessageFlags, timeout_msec : Int32, out_serial : UInt32*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun d_bus_connection_signal_subscribe = g_dbus_connection_signal_subscribe(this : DBusConnection*, sender : UInt8*, interface_name : UInt8*, member : UInt8*, object_path : UInt8*, arg0 : UInt8*, flags : LibGio::DBusSignalFlags, callback : Void*, user_data : Void*, user_data_free_func : Void*) : UInt32
  ...
  fun d_bus_message_new_method_call = g_dbus_message_new_method_call(name : UInt8*, path : UInt8*, interface_ : UInt8*, method : UInt8*) : LibGio::DBusMessage*
  fun d_bus_message_new_signal = g_dbus_message_new_signal(path : UInt8*, interface_ : UInt8*, signal : UInt8*) : LibGio::DBusMessage*
  ...
  # Implements Initable
    ...
    # Property get-proxy-type-destroy-notify : Void*
    # Property get-proxy-type-func : Void*
    # Property get-proxy-type-user-data : Void*
    # Property name : UInt8*
    # Property name-owner : UInt8*
    # Property object-path : UInt8*
  ...
  fun d_bus_object_skeleton_add_interface = g_dbus_object_skeleton_add_interface(this : DBusObjectSkeleton*, interface_ : LibGio::DBusInterfaceSkeleton*) : Void
  fun d_bus_object_skeleton_flush = g_dbus_object_skeleton_flush(this : DBusObjectSkeleton*) : Void
  fun d_bus_object_skeleton_remove_interface = g_dbus_object_skeleton_remove_interface(this : DBusObjectSkeleton*, interface_ : LibGio::DBusInterfaceSkeleton*) : Void
  ...
  # Implements Initable
    ...
    # Property g-interface-name : UInt8*
    # Property g-name : UInt8*
    # Property g-name-owner : UInt8*
    # Property g-object-path : UInt8*
  ...
  fun d_bus_proxy_new = g_dbus_proxy_new(connection : LibGio::DBusConnection*, flags : LibGio::DBusProxyFlags, info : LibGio::DBusInterfaceInfo*, name : UInt8*, object_path : UInt8*, interface_name : UInt8*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  fun d_bus_proxy_new_for_bus = g_dbus_proxy_new_for_bus(bus_type : LibGio::BusType, flags : LibGio::DBusProxyFlags, info : LibGio::DBusInterfaceInfo*, name : UInt8*, object_path : UInt8*, interface_name : UInt8*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  fun d_bus_proxy_call = g_dbus_proxy_call(this : DBusProxy*, method_name : UInt8*, parameters : LibGLib::Variant*, flags : LibGio::DBusCallFlags, timeout_msec : Int32, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun d_bus_proxy_call_with_unix_fd_list = g_dbus_proxy_call_with_unix_fd_list(this : DBusProxy*, method_name : UInt8*, parameters : LibGLib::Variant*, flags : LibGio::DBusCallFlags, timeout_msec : Int32, fd_list : LibGio::UnixFDList*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun data_input_stream_read_line_async = g_data_input_stream_read_line_async(this : DataInputStream*, io_priority : Int32, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun data_input_stream_read_until_async = g_data_input_stream_read_until_async(this : DataInputStream*, stop_chars : UInt8*, io_priority : Int32, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun data_input_stream_read_upto_async = g_data_input_stream_read_upto_async(this : DataInputStream*, stop_chars : UInt8*, stop_chars_len : Int64, io_priority : Int32, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun desktop_app_info_launch_uris_as_manager = g_desktop_app_info_launch_uris_as_manager(this : DesktopAppInfo*, uris : Void**, launch_context : LibGio::AppLaunchContext*, spawn_flags : LibGLib::SpawnFlags, user_setup : Void*, user_setup_data : Void*, pid_callback : Void*, pid_callback_data : Void*, error : LibGLib::Error**) : Bool
  ...
  fun file_enumerator_close_async = g_file_enumerator_close_async(this : FileEnumerator*, io_priority : Int32, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun file_enumerator_next_files_async = g_file_enumerator_next_files_async(this : FileEnumerator*, num_files : Int32, io_priority : Int32, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun file_i_o_stream_query_info_async = g_file_io_stream_query_info_async(this : FileIOStream*, attributes : UInt8*, io_priority : Int32, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun file_input_stream_query_info_async = g_file_input_stream_query_info_async(this : FileInputStream*, attributes : UInt8*, io_priority : Int32, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  struct FileMonitor # object
    ...
    # Property context : LibGLib::MainContext
  ...
  fun file_output_stream_query_info_async = g_file_output_stream_query_info_async(this : FileOutputStream*, attributes : UInt8*, io_priority : Int32, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  struct FilterInputStream # object
    ...
    # Property close-base-stream : Bool
  end
  ...
  fun i_o_stream_close_async = g_io_stream_close_async(this : IOStream*, io_priority : Int32, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun i_o_stream_splice_async = g_io_stream_splice_async(this : IOStream*, stream2 : LibGio::IOStream*, flags : LibGio::IOStreamSpliceFlags, io_priority : Int32, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  struct InetAddress # object
    ...
    # Property is-link-local : Bool
    # Property is-loopback : Bool
    # Property is-mc-global : Bool
    # Property is-mc-link-local : Bool
    # Property is-mc-node-local : Bool
    # Property is-mc-org-local : Bool
    # Property is-mc-site-local : Bool
    # Property is-multicast : Bool
    # Property is-site-local : Bool
  ...
  fun input_stream_close_async = g_input_stream_close_async(this : InputStream*, io_priority : Int32, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun input_stream_read_async = g_input_stream_read_async(this : InputStream*, buffer : UInt8*, count : UInt64, io_priority : Int32, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun input_stream_read_bytes_async = g_input_stream_read_bytes_async(this : InputStream*, count : UInt64, io_priority : Int32, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun input_stream_skip_async = g_input_stream_skip_async(this : InputStream*, count : UInt64, io_priority : Int32, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun memory_input_stream_new_from_data = g_memory_input_stream_new_from_data(data : UInt8*, len : Int64, destroy : Void*) : LibGio::InputStream*
  fun memory_input_stream_add_bytes = g_memory_input_stream_add_bytes(this : MemoryInputStream*, bytes : LibGLib::Bytes*) : Void
  fun memory_input_stream_add_data = g_memory_input_stream_add_data(this : MemoryInputStream*, data : UInt8*, len : Int64, destroy : Void*) : Void
  ...
  fun output_stream_close_async = g_output_stream_close_async(this : OutputStream*, io_priority : Int32, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun output_stream_flush_async = g_output_stream_flush_async(this : OutputStream*, io_priority : Int32, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun output_stream_splice_async = g_output_stream_splice_async(this : OutputStream*, source : LibGio::InputStream*, flags : LibGio::OutputStreamSpliceFlags, io_priority : Int32, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun output_stream_write_async = g_output_stream_write_async(this : OutputStream*, buffer : UInt8*, count : UInt64, io_priority : Int32, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun output_stream_write_bytes_async = g_output_stream_write_bytes_async(this : OutputStream*, bytes : LibGLib::Bytes*, io_priority : Int32, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  struct Permission # object
    ...
    # Property can-acquire : Bool
    # Property can-release : Bool
  ...
  fun permission_acquire_async = g_permission_acquire_async(this : Permission*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun permission_release_async = g_permission_release_async(this : Permission*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  # Implements SocketConnectable
    ...
    # Property destination-hostname : UInt8*
    # Property destination-port : UInt32
    # Property destination-protocol : UInt8*
    # Property password : UInt8*
    # Property protocol : UInt8*
    # Property uri : UInt8*
    # Property username : UInt8*
  ...
  fun resolver_lookup_by_address_async = g_resolver_lookup_by_address_async(this : Resolver*, address : LibGio::InetAddress*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun resolver_lookup_by_name_async = g_resolver_lookup_by_name_async(this : Resolver*, hostname : UInt8*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun resolver_lookup_records_async = g_resolver_lookup_records_async(this : Resolver*, rrname : UInt8*, record_type : LibGio::ResolverRecordType, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun resolver_lookup_service_async = g_resolver_lookup_service_async(this : Resolver*, service : UInt8*, protocol : UInt8*, domain : UInt8*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  struct Settings # object
    ...
    # Property delay-apply : Bool
    # Property has-unapplied : Bool
    # Property path : UInt8*
    # Property schema : UInt8*
    # Property schema-id : UInt8*
  ...
  fun settings_get_mapped = g_settings_get_mapped(this : Settings*, key : UInt8*, mapping : Void*, user_data : Void*) : Void*
  ...
  fun simple_async_result_new = g_simple_async_result_new(source_object : LibGObject::Object*, callback : Void*, user_data : Void*, source_tag : Void*) : LibGio::SimpleAsyncResult*
  fun simple_async_result_new_from_error = g_simple_async_result_new_from_error(source_object : LibGObject::Object*, callback : Void*, user_data : Void*, error : LibGLib::Error**) : LibGio::SimpleAsyncResult*
  ...
  # Implements ProxyResolver
    ...
    # Property default-proxy : UInt8*
    # Property ignore-hosts : UInt8**
  end
  ...
  # Implements Initable
    ...
    # Property multicast-loopback : Bool
  ...
  fun socket_address_enumerator_next_async = g_socket_address_enumerator_next_async(this : SocketAddressEnumerator*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun socket_client_connect_async = g_socket_client_connect_async(this : SocketClient*, connectable : LibGio::SocketConnectable*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun socket_client_connect_to_host_async = g_socket_client_connect_to_host_async(this : SocketClient*, host_and_port : UInt8*, default_port : UInt16, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun socket_client_connect_to_service_async = g_socket_client_connect_to_service_async(this : SocketClient*, domain : UInt8*, service : UInt8*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun socket_client_connect_to_uri_async = g_socket_client_connect_to_uri_async(this : SocketClient*, uri : UInt8*, default_port : UInt16, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun socket_connection_connect_async = g_socket_connection_connect_async(this : SocketConnection*, address : LibGio::SocketAddress*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun socket_listener_accept_async = g_socket_listener_accept_async(this : SocketListener*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun socket_listener_accept_socket_async = g_socket_listener_accept_socket_async(this : SocketListener*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun subprocess_communicate_async = g_subprocess_communicate_async(this : Subprocess*, stdin_buf : LibGLib::Bytes*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun subprocess_communicate_utf8_async = g_subprocess_communicate_utf8_async(this : Subprocess*, stdin_buf : UInt8*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun subprocess_wait_async = g_subprocess_wait_async(this : Subprocess*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun subprocess_wait_check_async = g_subprocess_wait_check_async(this : Subprocess*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun subprocess_launcher_set_child_setup = g_subprocess_launcher_set_child_setup(this : SubprocessLauncher*, child_setup : Void*, user_data : Void*, destroy_notify : Void*) : Void
  ...
  fun task_new = g_task_new(source_object : LibGObject::Object*, cancellable : LibGio::Cancellable*, callback : Void*, callback_data : Void*) : LibGio::Task*
  fun task_is_valid = g_task_is_valid(result : LibGio::AsyncResult*, source_object : LibGObject::Object*) : Bool
  fun task_report_error = g_task_report_error(source_object : LibGObject::Object*, callback : Void*, callback_data : Void*, source_tag : Void*, error : LibGLib::Error**) : Void
  ...
  fun task_return_pointer = g_task_return_pointer(this : Task*, result : Void*, result_destroy : Void*) : Void
  ...
  fun task_set_task_data = g_task_set_task_data(this : Task*, task_data : Void*, task_data_destroy : Void*) : Void

  struct TcpConnection # object
    parent_instance : LibGio::SocketConnection
    priv : LibGio::TcpConnectionPrivate*
    # Property graceful-disconnect : Bool
  end
  ...
  # Implements Icon
    ...
    # Property use-default-fallbacks : Bool
  end
  ...
  struct TlsCertificate # object
    ...
    # Property certificate-pem : UInt8*
    # Property issuer : LibGio::TlsCertificate
    # Property private-key : Void**
    # Property private-key-pem : UInt8*
  ...
  struct TlsConnection # object
    ...
    # Property require-close-notify : Bool
    # Property use-system-certdb : Bool
  ...
  fun tls_connection_handshake_async = g_tls_connection_handshake_async(this : TlsConnection*, io_priority : Int32, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun tls_database_lookup_certificate_for_handle_async = g_tls_database_lookup_certificate_for_handle_async(this : TlsDatabase*, handle : UInt8*, interaction : LibGio::TlsInteraction*, flags : LibGio::TlsDatabaseLookupFlags, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun tls_database_lookup_certificate_issuer_async = g_tls_database_lookup_certificate_issuer_async(this : TlsDatabase*, certificate : LibGio::TlsCertificate*, interaction : LibGio::TlsInteraction*, flags : LibGio::TlsDatabaseLookupFlags, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun tls_database_lookup_certificates_issued_by_async = g_tls_database_lookup_certificates_issued_by_async(this : TlsDatabase*, issuer_raw_dn : Void**, interaction : LibGio::TlsInteraction*, flags : LibGio::TlsDatabaseLookupFlags, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun tls_database_verify_chain_async = g_tls_database_verify_chain_async(this : TlsDatabase*, chain : LibGio::TlsCertificate*, purpose : UInt8*, identity : LibGio::SocketConnectable*, interaction : LibGio::TlsInteraction*, flags : LibGio::TlsDatabaseVerifyFlags, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun tls_interaction_ask_password_async = g_tls_interaction_ask_password_async(this : TlsInteraction*, password : LibGio::TlsPassword*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun tls_interaction_request_certificate_async = g_tls_interaction_request_certificate_async(this : TlsInteraction*, connection : LibGio::TlsConnection*, flags : LibGio::TlsCertificateRequestFlags, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun tls_password_set_value_full = g_tls_password_set_value_full(this : TlsPassword*, value : UInt8*, length : Int64, destroy : Void*) : Void
  ...
  fun unix_connection_receive_credentials_async = g_unix_connection_receive_credentials_async(this : UnixConnection*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun unix_connection_send_credentials_async = g_unix_connection_send_credentials_async(this : UnixConnection*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  # Callback: AsyncReadyCallback(source_object : LibGObject::Object*, res : LibGio::AsyncResult*, user_data : Void*) : Void
  # Callback: BusAcquiredCallback(connection : LibGio::DBusConnection*, name : UInt8*, user_data : Void*) : Void
  # Callback: BusNameAcquiredCallback(connection : LibGio::DBusConnection*, name : UInt8*, user_data : Void*) : Void
  # Callback: BusNameAppearedCallback(connection : LibGio::DBusConnection*, name : UInt8*, name_owner : UInt8*, user_data : Void*) : Void
  # Callback: BusNameLostCallback(connection : LibGio::DBusConnection*, name : UInt8*, user_data : Void*) : Void
  # Callback: BusNameVanishedCallback(connection : LibGio::DBusConnection*, name : UInt8*, user_data : Void*) : Void
  # Callback: CancellableSourceFunc(cancellable : LibGio::Cancellable*, user_data : Void*) : Bool
  # Callback: DBusInterfaceGetPropertyFunc(connection : LibGio::DBusConnection*, sender : UInt8*, object_path : UInt8*, interface_name : UInt8*, property_name : UInt8*, error : LibGLib::Error**, user_data : Void*) : LibGLib::Variant*
  # Callback: DBusInterfaceMethodCallFunc(connection : LibGio::DBusConnection*, sender : UInt8*, object_path : UInt8*, interface_name : UInt8*, method_name : UInt8*, parameters : LibGLib::Variant*, invocation : LibGio::DBusMethodInvocation*, user_data : Void*) : Void
  # Callback: DBusInterfaceSetPropertyFunc(connection : LibGio::DBusConnection*, sender : UInt8*, object_path : UInt8*, interface_name : UInt8*, property_name : UInt8*, value : LibGLib::Variant*, error : LibGLib::Error**, user_data : Void*) : Bool
  # Callback: DBusMessageFilterFunction(connection : LibGio::DBusConnection*, message : LibGio::DBusMessage*, incoming : Bool, user_data : Void*) : LibGio::DBusMessage*
  # Callback: DBusProxyTypeFunc(manager : LibGio::DBusObjectManagerClient*, object_path : UInt8*, interface_name : UInt8*, user_data : Void*) : UInt64
  # Callback: DBusSignalCallback(connection : LibGio::DBusConnection*, sender_name : UInt8*, object_path : UInt8*, interface_name : UInt8*, signal_name : UInt8*, parameters : LibGLib::Variant*, user_data : Void*) : Void
  # Callback: DBusSubtreeDispatchFunc(connection : LibGio::DBusConnection*, sender : UInt8*, object_path : UInt8*, interface_name : UInt8*, node : UInt8*, out_user_data : Void*, user_data : Void*) : LibGio::DBusInterfaceVTable*
  # Callback: DBusSubtreeIntrospectFunc(connection : LibGio::DBusConnection*, sender : UInt8*, object_path : UInt8*, node : UInt8*, user_data : Void*) : LibGio::DBusInterfaceInfo*
  # Callback: DesktopAppLaunchCallback(appinfo : LibGio::DesktopAppInfo*, pid : Int32, user_data : Void*) : Void
  # Callback: FileMeasureProgressCallback(reporting : Bool, current_size : UInt64, num_dirs : UInt64, num_files : UInt64, user_data : Void*) : Void
  # Callback: FileProgressCallback(current_num_bytes : Int64, total_num_bytes : Int64, user_data : Void*) : Void
  # Callback: FileReadMoreCallback(file_contents : UInt8*, file_size : Int64, callback_data : Void*) : Bool
  # Callback: IOSchedulerJobFunc(job : LibGio::IOSchedulerJob*, cancellable : LibGio::Cancellable*, user_data : Void*) : Bool
  # Callback: PollableSourceFunc(pollable_stream : LibGObject::Object*, user_data : Void*) : Bool
  # Callback: SettingsBindGetMapping(value : LibGObject::Value*, variant : LibGLib::Variant*, user_data : Void*) : Bool
  # Callback: SettingsBindSetMapping(value : LibGObject::Value*, expected_type : LibGLib::VariantType*, user_data : Void*) : LibGLib::Variant*
  # Callback: SettingsGetMapping(value : LibGLib::Variant*, result : Void**, user_data : Void*) : Bool
  # Callback: SimpleAsyncThreadFunc(res : LibGio::SimpleAsyncResult*, object : LibGObject::Object*, cancellable : LibGio::Cancellable*) : Void
  # Callback: SocketSourceFunc(socket : LibGio::Socket*, condition : LibGLib::IOCondition, user_data : Void*) : Bool
  # Callback: TaskThreadFunc(task : LibGio::Task*, source_object : LibGObject::Object*, task_data : Void*, cancellable : LibGio::Cancellable*) : Void
  ...
  fun app_info_reset_type_associations = g_app_info_reset_type_associations(content_type : UInt8*) : Void
  fun async_initable_newv_async = g_async_initable_newv_async(object_type : UInt64, n_parameters : UInt32, parameters : LibGObject::Parameter*, io_priority : Int32, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  fun bus_get = g_bus_get(bus_type : LibGio::BusType, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun dbus_address_get_stream = g_dbus_address_get_stream(address : UInt8*, cancellable : LibGio::Cancellable*, callback : Void*, user_data : Void*) : Void
  ...
  fun io_scheduler_push_job = g_io_scheduler_push_job(job_func : Void*, user_data : Void*, notify : Void*, io_priority : Int32, cancellable : LibGio::Cancellable*) : Void
  fun network_monitor_get_default = g_network_monitor_get_default() : LibGio::NetworkMonitor*
  ...
  fun settings_schema_source_get_default = g_settings_schema_source_get_default() : LibGio::SettingsSchemaSource*
  fun simple_async_report_gerror_in_idle = g_simple_async_report_gerror_in_idle(object : LibGObject::Object*, callback : Void*, user_data : Void*, error : LibGLib::Error**) : Void
  fun tls_backend_get_default = g_tls_backend_get_default() : LibGio::TlsBackend*
  fun tls_client_connection_new = g_tls_client_connection_new(base_io_stream : LibGio::IOStream*, server_identity : LibGio::SocketConnectable*, error : LibGLib::Error**) : LibGio::TlsClientConnection*
  fun tls_error_quark = g_tls_error_quark() : UInt32
  fun tls_file_database_new = g_tls_file_database_new(anchors : UInt8*, error : LibGLib::Error**) : LibGio::TlsFileDatabase*
